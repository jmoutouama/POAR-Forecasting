...
plot(crop_pptdorm_raster,xlab="Longitude",ylab="Latitude")
mtext("A",side = 3, adj = 0,cex=1.25,line=0)
title(main="Dormant season precip",adj=0.1,line=0.2)
...
plot(crop_tempdorm_raster,xlab="Longitude",ylab="Latitude")
mtext("B",side = 3, adj = 0,cex=1.25,line=0)
title(main="Dormant season temp",adj=0.1,line=0.2)
plot(study_area,add=T)
...
plot(crop_pptgrow_raster,xlab="Longitude",ylab="Latitude")
mtext("C",side = 3, adj = 0,cex=1.25,line=0.2)
title(main="Growing season precip",adj=0.1,line=0.2)
plot(study_area,add=T)
plot(gbif,add=T,pch = 23,col="grey50",bg="grey",cex =0.5)
plot(garden,add=T,pch = 21,col="black",cex =1.25,bg="black")
plot(source,add=T,pch = 21,col="black",bg="red",cex =1)

plot(crop_tempgrow_raster,xlab="Longitude",ylab="Latitude")
mtext("D",side = 3, adj = 0,cex=1.25,line=0.2)
title(main="Growing season temp",adj=0.1,line=0.2)
plot(study_area,add=T)
plot(gbif,add=T,pch = 23,col="grey50",bg="grey",cex =0.5)
plot(garden,add=T,pch = 21,col="black",cex =1.25,bg="black")
plot(source,add=T,pch = 21,col="black",bg="red",cex =1)
...
plot(source,add=T,pch = 3,col="black",bg="red",cex =2)
mtext( "A",side = 3, adj = 0,cex=1.25,line=0.2)
legend(-106, 28.5, 
       legend=c( "GBIF occurences","Common garden sites","Source populations"),
       pch = c(23,1,3),
...
arrows(clim_current$pptdorm,clim_current$tempdorm,
       ...
       length=0.1,col=unique(poar_2015_2016$site_col),lty=5,lwd=1)
...
legend("topright",legend=c("Past (1901-1930)","Observed (2014-2016)","RCP4.5 (2071-2100)","RCP8.5 (2071-2100)"),lty=c(1,1,5,3),lwd=c(2,1,1,1),col="black",cex = 0.9)
#points(clim_current$pptdorm,clim_current$tempdorm,col="black",cex=1,pch=16)
...
normal_vs_obs<-left_join(poar_2015_2016,cbind(garden@coords,clim_current), by=c("Longitude","Latitude"))
