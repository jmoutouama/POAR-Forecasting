...
\begin{figure}[H]
  ...
  \caption{A two‐dimensional representation of the predicted niche shift over time (past, present and future climate conditions) based on Pr ($\lambda > 1$). 
 ...
 (A) Niche of dormant season for the two sex model , (B) Niche of growing season for the two sex model,
  Niche of dormant season for female dominant model (C), Niche of growing season for female dominant model.
