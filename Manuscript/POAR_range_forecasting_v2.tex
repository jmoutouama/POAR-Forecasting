...
To back-cast and forecast demographic responses to changes in climate throughout the study region, we also downloaded projection data for three 30-year periods: ``past'' (1901-1930), ``current'' (1990-2019) and ``future'' (2070-2100).
...
Projection data for the three 30-year periods included warmer or colder conditions than observed in our experiment (Figure \ref{Sup:projectionMIROC}, Figure \ref{Sup:projectionACCESS}, Figure \ref{Sup:projectionCESM1}, Figure \ref{Sup:projectionCMCC}), so extending our inferences to these conditions required extrapolation, as we describe below. 
\tom{However, the observed period was substantially wetter and cooler across the study region than 2015-16, especially during the growing season (Figure \ref{Sup:climate_variation}), so our study design provides both spatial and inter-annual coverage of climate variables.}{I struggle to follow this sentence. I know one of the years was very different from the 30-year normal, which is good because it gives more climate coverage, but I think this can be explained more directly.} 
...
To understand the impact of climate change on species niche shifts, we estimated the probability of self- sustaining populations, which is Pr ($\lambda \ge 1$) conditional to temperature and precipitation of the dormant and growing seasons.
Pr ($\lambda > 1$) was calculated for the two-sex model and the female dominant MPMs using the proportion of the 300 MCMC samples that lead to a $\lambda \ge 1$ \citep{diez2014probabilistic}.
...
We also visualized how our common garden sites have ``moved'' through climate space through time due to climate change. 
