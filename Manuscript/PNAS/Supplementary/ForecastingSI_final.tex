...
To understand the impact of climatic variation across common garden sites on sex ratio (OSR and SR), we used  bayesian models  to propagate the uncertainty in our estimates of the  the expected value ($\nu$)(Eq.\ref{eq:sr_fn}):
...
Seed viability was modeled to propagate the uncertainty in our estimates with a binomial distribution where the probability of viability ($v$) was given by:
