...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{tom_map_v1.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.99\linewidth]{Posterior_mean.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.80\linewidth]{POAR_OSR_MIROC_CES_ACC.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{Fig_geo_sr_cmc.pdf}
\caption{Projection  of Operational Sex Ratio (proportion of female panicle) over time (past, present, future) across species range.
			Future projections were based on the CMCC-CM model.
			OSR is conditional on population viability Pr ($\lambda > 1$).
			}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{Fig_geo_sr_ces.pdf}
