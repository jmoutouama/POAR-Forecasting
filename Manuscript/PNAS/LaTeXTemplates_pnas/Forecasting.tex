...
Both model versions predict that future climate change will will induce a poleward shift of niche suitability beyond current northern limits.
...
is distributed along environmental gradients in the south-central U.S. corresponding to variation in temperature of dormant and growing season across latitude and precipitation of dormant and growing season across longitude (Fig. S1). 
\textit{common garden and sex ratio manipulation summary sentence here}
...
Across \tom{14}{check} common garden sites, operational sex ratio (proportion of panicles that are female) of the experimental populations was female-biased on average ($\approx 60$ \% female), reflecting the overall greater rates of female vs. male flowering. 
...
Female-dominant and two-sex models diverged most strongly in regions of niche space that favored strongly female-biased operational sex ratios \tom{(Fig. S12)}{Is this the figure you cut?}, suggesting mate limitation as the biological mechanism underlying model differences. 
...
\tom{For example, studies suggested that cool-season grass species can have delayed phenology in response to global warming, particularly if temperatures rise above their physiological tolerances \citep{williams2015life}.}{This is not the correct citation.}
...
\tom{These vital rate models included main effects of size (the natural log of tiller number), sex, and seasonal climate covariates (SI Appendix, section B). }{Missing info about interactions!}
...
\tom{}{Need to say what is v for the F-dominant model.}
