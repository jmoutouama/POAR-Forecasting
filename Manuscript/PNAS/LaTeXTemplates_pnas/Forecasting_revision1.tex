...
Across dioecious plants, studies suggest that future climate change toward hotter and drier conditions may favor male-biased sex ratios, \tom{likely to due lower costs of male reproduction that enable greater stress tolerance}{I added, see if you think it makes sense here.} \citep{field2013comparative,hultine2016climate}. 
...
\tom{Regression coefficients related to sex and/or sex:size interactions were significantly non-zero (95\% credible intervals excluding zero) \revise{\linelabel{vitalrate} particularly for  survival and  growth rates} (Fig. S3), suggesting sexual divergence in demography. 
Females generally had an advantage over males, especially in survival and flowering (Fig. \ref{fig:vital_rates}). }{These two sentences feel a little contradictory -- one emphasizes that difference in survival and growth, and the other emphasizes survival and flowering.}
...
Female-dominant  and two-sex versions of the MPM  both allow for sex-specific response to climate, but only the two-sex model accounts for the feedback between OSR and seed fertilization (pollen limitation under female-biased sex ratios: \tom{Fig. X}{Reference the seed fertilization figure in the supplement.}).
...
Figure \ref{fig:niche} shows the estimated probability of population viability ($\lambda \ge 1$) across seasonal climate niche space; these probabilities account for uncertainty in the vital rate parameters as well as process error related to the spatial heterogeneity and genotypic variation incorporated into our experimental design. 
...
Across growing season climate space, the female-dominant model over-estimates population viability by 9.2\%, on average (Fig. \ref{fig:niche}\revise{\linelabel{panelfig3}F}, Fig. S11, Fig. S12)).\tom{}{I don't think you should reference Fig S11 here. And Fig S12 is the same as what's in the main text figure.} 
The difference between female-dominant and two-sex models was qualitatively similar but weaker in magnitude for niche dimensions of the dormant season (Fig. \ref{fig:niche}E, Fig. S11). \tom{}{I think these sentences were referencing the wrong panels. I updated this, but you should double check, and generally make sure that all figures (including in the supplement) are referenced appropriately.}
\tom{Female-dominant and two-sex models diverged most strongly in regions of niche space that favored strongly female-biased operational sex ratios}{Wasn't there a figure supporting this statement?}, suggesting mate limitation as the biological mechanism underlying model differences. 
...
This predicted poleward niche shift is highly consistent across different global circulation models (Fig. S14, Fig. S15, Fig. S16). 
...
These hotspots are generally regions of predicted strong female bias in the operational sex ratio (Fig. S17 to Fig. S20). \tom{}{I wonder if we could try plotting the correlation between the predicted sex ratio and the disagreement between F and FM models. We could do this for both niche and geography.}
...
\revise{\linelabel{femaledmod} While a two-sex modeling approach clearly adds biological realism, it was also additional work (in the form of experiments, data, equations, code, and computation). 
...
%\revise{\linelabel{femaledmod} This is good news from a conservation standpoint because most studies on dioecious species rely on models that assume male availability has no influence on female fertility \citep{caswell1986two}}.
...
This suggests a particularly important role of sex-structured modeling for threatened and endangered species, as conservation biologists have already recognized \citep{jenouvrier2012effects}. 
}\tom{}{You have labeled this paragraph as revised, but I do not see anything different about it. Also, there were some additional citations in this last sentence that I think are worth keeping. There is a famous example of taiga antelope.}
...
Here, the female bias was not a direct response to climate, such as temperature-dependent sex determination, but rather due to climate-induced changes in vital rates that accumulate throughout the life cycle.
...
\revise{\linelabel{seasonality} 
%One aspect of our study suggests that 
Climate conditions during the dormant season are at least as important as those during the growing season. 
This result contrasts with a recent synthesis suggesting that only the dormant season matters for plants \citep{evers2021lagged}. 
Temperature and precipitation during the dormant season significantly impact  population dynamics.
For instance, the reduction of snowpack, which protects plants from frost damage through insulation, could decrease plants probability of flowering \citep{groffman2001colder}. 
...
%In seasonally arid regions such as our study area, precipitation can have a complex impact on vital rates, including plant  survival and growth rates.
Intense precipitation may lead to flooding or waterlogged soils, which can harm plant roots and consequently reduce their growth and survival. 
Furthermore, increase precipitation  could stimulate rapid plant growth, leading to increased competition for resources among species.}\tom{}{I would like to talk about this paragraph before you finalize the manuscript. I don't think the snowfall examples are very relevant here, and I am generally not sure what this paragraph is meant to accomplish. I don't think the results ``contrast'' with Evers et al. I think they are consistent in saying that dormant season matters.}
...
\revise{But in broad strokes, a female-dominant perspective tells much of the story, and that will likely be true for dioecious plants and animals with mating systems in which few males can fertilize many females.}\tom{}{Again, you show this as revised, but I think it is the same as the original sentence.}
...
Texas bluegrass (\textit{Poa arachnifera}) is a dioecious perennial, cool-season (C3) grass that occurs in the south-central U.S. (Texas, Oklahoma, and southern Kansas) (Figure \ref{fig:study_design}) \citep{hitchcock1971manual}. 
...
Biological sex is genetically based and the birth (seed) sex ratio is 1:1 \citep{renganayaki2005identification}. \tom{}{I think you could cite the book chapter I forwarded for 1:1 sex ratio. See my email.}
...
This region has experienced \textit{ca.} 0.5 \degree C of climate warming since 1900, with faster warming during the cool-season months ($0.0055 \degree C / yr$) than the hot summers ($0.0046\degree C / yr$) \tom{(Fig. S2)}{At some point I think you switched Figures 1 and S2. I think this is meant to be Fig 1. CHeck this throughout the paper.}.
...
On the other hand, precipitation has increased over the past century for much of the region but is forecasted to decline back to early-20th century levels \tom{(Fig. S2)}{Same comment.}.
...
For each block we planted three female and three male individuals that were clonally propagated from females and males from \revise{\linelabel{sourcepop} seven} natural source populations (Figure \ref{fig:study_design}A); clones never deviated from their expected sex. 
...
We assessed the fit of the models using posterior predictive checks \citep{piironen2017comparison} (Fig. S23).
...
We used the climate-dependent vital rate regressions estimated above, combined with \revise{\linelabel{seed} additional data on seed number, seed viability and seed germination} to build female-dominant and two-sex versions of a climate-explicit matrix projection model (MPMs) structured by the discrete state variables size (number of tillers) and sex.
...
Let $F_{x,\ t}$ and $M_{x,\ t}$ be the number of female and male plants of size $x$ in year $t$, where $x$  \revise{\linelabel{size} is a natural number with $x \in [1,...\ U]$.
...
\revise{We estimated these parameters using data from a sex ratio manipulation experiment, conducted in the center of the range, in which seed fertilization was measured in plots of varying OSR; this experiment is described elsewhere  \citep{compagnoni2017can} and is summarized in (SI Appendix, section D).}\tom{}{Did you make any change here?}
This experiment also provided  \revise{\linelabel{uncertainty} parameters for seed number per panicle ($d$) and germination rate ($m$).
All parameter estimates related to seed production, seed viability, and germination were estimated in Bayesian framework, and their uncertainty was propagated into the MPM along with that of other demographic rates}. 
...
The model described above yields a $2(U+1) \times 2(U+1)$ transition matrix. \tom{}{Here I would explain how this is an MPM but it is parameterized like an IPM, responding to the comments from reviewer 1.}
