...
\begin{enumerate}
	...
	\item Including in the discussion elements related to the effect of climate change on sex ratio not only for animals but also for plants. -- TOM: I think this has not been done.
...
TOM: the footnote is getting spread across two pages.}%
...
We added content to the Discussion section regarding potential mechanisms by which dormant season climate could be important (line  358- line 366).}
...
TOM: Be sure to add these citations.
}
...
TOM: I think there is more work to do here.}
...
\response{Good catch. Yes, we referred to the wrong figure panels. We have updated the Figure panels (line 164). Thank you.}
...
\response{ We thank the reviewer for this suggestion to expanding the reach of our work. We have added in Discussion sentences that addresses shifts in sex ratio as a general feature of climate change that has been documented in both plants and animals (line 340 - line 345).
We have also updated the significance statement.

TOM: I think there is more work to do on this one.}
...
But to incorporate this suggestion we now address the importance of both the dormant and growing season as well as the mechanisms by which the dormant season could affect population growth (line 358 - line 366). 
\\
...
We highlighted the differences and similarities between projections from models in the discussion (line 272 -line 302) and the conclusion  (line 419 -line 422). We have now added the implication for conservations in the manuscript (line  283 - line  285).

TOM: I think the revisions for this comment can be improved.}
