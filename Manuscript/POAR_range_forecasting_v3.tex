...
Texas bluegrass (\textit{Poa arachnifera}) is a dioecious perennial, summer-dormant cool-season (C3) grass that occurs in the south-central U.S. (Texas, Oklahoma, and southern Kansas) (Figure \ref{fig:study_design}) \citep{hitchcock1971manual}\jacob{}{I have updated the map}.\tom{}{I think the GBIF records greatly underestimate the distribution, especially in Oklahoma. Compare this to the county records map in the Am Nat paper. I am not sure how that happens--I assumed that GBIF would be pulling all those county records. } 
\tom{Latitudinal limits of the Texas bluegrass distribution span 7.74 \degree C to 16.94 \degree C of temperature during the dormant season and 24.38 \degree C to 28.80 \degree C  during the dormant season. 
Longitudinal limits span 244.9 mm to 901.5 mm of precipitation during the growing season and 156.3 mm to 373.3 mm. }{Rather than just describe climate, this would be a good place to say more about climate change. For example, summer temperatures have increased by XX-XX degrees C since 1900, and climate models predict another XX-XX degrees of warming by 2100. Compare summer warming to winter warming, and compare temperature change to precipitation change. All of this sets the stage for why this is an important system to forecast climate change responses.}
...
Following this life history, we divide the calendar year into growing (October 1 - May 31) and dormant (June 1 - September 30) seasons. 
...
However, across all sites, both study years were 2-3\degree C warmer than their corresponding 1990--2019 temperature normals (Fig. \ref{Sup:climate_normal_weather}). 
...
Thus, the geographic and inter-annual replication of the common garden experiment provided good coverage of most past, present, and future conditions throughout the study region (Fig. \ref{Sup:projectionMIROC}, Fig. \ref{Sup:projectionACCESS}, Fig. \ref{Sup:projectionCESM1}, Fig. \ref{Sup:projectionCMCC}). 
...
To understand how climate shapes the niche and geographic range of Texas bluegrass, we estimated the probability of self- sustaining populations, which is Pr ($\lambda \ge 1$) conditional to temperature and precipitation of the dormant and growing seasons.
...
We found strong demographic responses to climate drivers across our Texas bluegrass common garden sites and evidence for demographic differences between the sexes. 
\tom{}{I am skipping the rest of this section for now because I think the figure needs to be re-worked and that will change the rest of this paragraph. I also think this section should include the common garden sex ratio results, since they are connected to the vital rate responses.}
...
\tom{}{I moved this section because it only makes sense with respect to the geographic projections, because the histograms are showing distributions across the study region. Are these locations conditional on lambda greater than 1 or Pr lambda greater than some value?}
...
\begin{figure}[H]
	...
	\caption{Seasonal climate variation (temperature in \degree C and precipitation in $mm$) across the common garden sites during the 2014--15 and 2015--16 census periods. Each color represents a site and lines connect the same site between years.}
