...
However, the magnitude of niche shift was overestimated by the female-dominant model, because females have broader temperature tolerance than males and become mate-limited under female-biased sex ratios.
...
\section*{Results}
\subsection*{Varation in sex-ratio along climate gradient}

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.85\linewidth]{Figures/gardens_OSR.pdf}
  \caption{\textbf{Variation in Operational Sex-ratio accross climate gradient}.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.99\linewidth]{Figures/lambda_past_present_future_LTRE.pdf}
