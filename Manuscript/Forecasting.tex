...
%Several studies reported female bias sex ratio. 
...
%Our ability to track the impact of climate change on the population dynamics of dioecious plants depends on our ability to build mechanistic models that take into account the spatial and temporal context in which survival, reproduction, and growth occur due to the sessile nature of these plants \citep{evans2016towards,czachura2020demographic}.
%Several studies found that climate change affects demographic processes in distinctive and potentially contrasting ways \citep{dalgleish2011climate}. 
%For example, while climate has a significant effect on the probability of survival and growth, it has no effect on the probability of flowering \citep{greiser2020climate}. 
%\tom{Additionally, under warmer conditions, some species will fail to establish reproductive populations due to the extremely low germination rate and seedling survival \citep{Reed2021}. }{I am not sure why you are specifically identifying germination and seedling survival here. There are many pathways of population decline under warming.}
%Therefore, climate change will reduce the population growth rate and the range size of these species \citep{reed2021climate}. 
...
%\tom{In seabird populations, climate change favored population growth by increasing the survival rate of both sexes \citep{gianuca2019sex}.}{This is an example of a problem throughout the introduction, which is that you switch between talking about effects on population growth (as in this example) and effects on range dynamics -- these are related but different, and I think you need to clarify that relationship.}
...
\tom{We studied 14 sites along the distribution of these species in the United States in 2014 and 2015. }{You need to make clear that this was a common garden experiment. Describe the experiment in sufficient detail.}
