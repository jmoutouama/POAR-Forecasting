...
## Climatic data for the model with annual data (precipitation, annual mean temprature and their coefficient of variation) 
```{r}
poar_ppt %>% 
...
## Match annual climatic data with demographic data
...
saveRDS(fit_allsites_surv_annual, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_survivalannual.rds')
...
## Second  model: annual data with polynomial 2 order

### Running the stan model
```{r}
fit_allsites_surv_annual_polyn <- stan(
 file = "/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/stan/poar_survivalannualpolynomial.stan",
 data = poar_sites_annual.surv,
 warmup = sim_pars$warmup,
 iter = sim_pars$iter,
 thin = sim_pars$thin,
...
saveRDS(fit_allsites_surv_annual_polyn, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_survivalannualpolynomial.rds')
```
...
```{r}
log_lik_surv_annual_polyn <- loo::extract_log_lik(fit_allsites_surv_annual_polyn, merge_chains = FALSE)
r_eff_surv_annual_polyn <- loo::relative_eff(exp(log_lik_surv_annual_polyn))
loo_surv_annual_polyn <- loo(log_lik_surv_annual_polyn, r_eff = r_eff_surv_annual_polyn, cores = 2)
# print(loo_surv_annual_polyn)
# plot(loo_surv_annual)
```

## Third  model: seasonnal data 
### Reshape the data
```{r}
# Survival
poar.clim_seasonal %>% 
...
saveRDS(fit_allsites_surv_season, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_survival_season.rds')
```
...
saveRDS(fit_allsites_surv_season_polyn, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_survival_seasonpolynomial.rds')
```

```{r}
traceplot(fit_allsites_surv_season_polyn, pars = c("b0_s", "bsize_s","bpptgrow_s","bpptdorm_s","btempgrow_s","btempdorm_s","bpptgrowsex_s","bpptdormsex_s","btempgrowsex_s","btempdormsex_s","btempdormpptdormsex_s","btempgrowpptgrowsex_s","bpptgrow2_s","bpptdorm2_s","btempgrow2_s","btempdorm2_s","bpptgrow2sex_s","bpptdorm2sex_s","btempgrow2sex_s","btempdorm2sex_s"), inc_warmup = TRUE, nrow =15 )
```
...
color_scheme_set("blue")
mcmc_intervals(posteriorsurvannual_polyn, pars = c("b0_s", "bsize_s","bsex_s","bppt_s","btemp_s","bcvppt_s","bpptsex_s","btempsex_s","bcvpptsex_s","bppttempsex_s","bppt2_s","btemp2_s","bcvppt2_s","bppt2sex_s","btemp2sex_s","bcvppt2sex_s"))+ geom_vline(xintercept = 0, linetype = 2)+theme_bw()
```
...
predSA <- rstan::extract(fit_allsites_surv_annual, pars = c("predS"))$predS
predSPA <- rstan::extract(fit_allsites_surv_annual_polyn, pars = c("predS"))$predS
...
y_sa_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.surv$y_s))
y_spa_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.surv$y_s))
...
for(i in 1:n_post_draws){
  ...
  y_sa_sim [i,] <- rbinom(n=length(poar_sites_annual.surv$y_s), size=1, prob = invlogit(predSA[i,]))
  ## sample flowering data (bernoulli)
  y_spa_sim[i,] <- rbinom(n=length(poar_sites_annual.surv$y_s), size=1, prob = invlogit(predSPA[i,]))
  ## sample survival data (bernoulli)
...
```{r}
ppc_dens_overlay(poar_sites_annual.surv$y_s, y_sa_sim)+
  xlab("Survival status")+ylab("Density")+
  ggtitle(("Annual"))+theme(legend.position = "none")->ppc_surv_annual

ppc_dens_overlay(poar_sites_annual.surv$y_s, y_spa_sim)+
  xlab("Survival status")+ylab("Density")+
  ggtitle(("Annual Polynomial"))+theme(legend.position = "none")->ppc_surv_annualpolyn


ppc_dens_overlay(poar_sites_season.surv$y_s, y_ss_sim)+
  xlab("Survival status")+ylab("Density")+
  ggtitle(("Seasonal"))+theme(legend.position = "none")->ppc_surv_season


ppc_dens_overlay(poar_sites_season.surv$y_s, y_sps_sim)+
  xlab("Survival status")+ylab("Density")+
  ggtitle(("Seasonal Polynomial"))+theme(legend.position = "none")->ppc_surv_season_polyn
...
# multiplot(ppc_surv_annual,ppc_surv_annualpolyn,ppc_surv_season,
...
```{r}
surv_coefsa <- rstan::extract(fit_allsites_surv_annual, c("b0_s", "bsize_s","bsex_s","bppt_s","btemp_s","bcvppt_s","bpptsex_s","btempsex_s","bcvpptsex_s","bppttempsex_s"))

surv_coefsp <- rstan::extract(fit_allsites_surv_annual_polyn, c("b0_s", "bsize_s","bsex_s","bppt_s","btemp_s","bcvppt_s","bpptsex_s","btempsex_s","bcvpptsex_s","bppttempsex_s","bppt2_s","btemp2_s","bcvppt2_s","bppt2sex_s","btemp2sex_s","bcvppt2sex_s"))

surv_coefss <- rstan::extract(fit_allsites_surv_season, c("b0_s","bsex_s", "bsize_s","bpptgrow_s","bpptdorm_s","btempgrow_s","btempdorm_s","bpptgrowsex_s","bpptdormsex_s","btempgrowsex_s","btempdormsex_s","btempdormpptdormsex_s","btempgrowpptgrowsex_s"))

surv_coefssp <- rstan::extract(fit_allsites_surv_season_polyn, c("b0_s","bsex_s", "bsize_s","bpptgrow_s","bpptdorm_s","btempgrow_s","btempdorm_s","bpptgrowsex_s","bpptdormsex_s","btempgrowsex_s","btempdormsex_s","btempdormpptdormsex_s","btempgrowpptgrowsex_s","bpptgrow2_s","bpptdorm2_s","btempgrow2_s","btempdorm2_s","bpptgrow2sex_s","bpptdorm2sex_s","btempgrow2sex_s","btempdorm2sex_s"))
...
with(zpoar_surv_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(ppt_seq,invlogit(mean(surv_coefsa$b0_s) + 
                        ...
                        mean(surv_coefsa$bppttempsex_s) * ppt_seq * surv_mean_temp$temp[surv_mean_temp$Sex==s] * surv_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) 
...
with(zpoar_surv_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(temp_seq,invlogit(mean(surv_coefsa$b0_s) + 
                        ...
                        mean(surv_coefsa$bcvpptsex_s) * surv_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) +
                        mean(surv_coefsa$bppttempsex_s) * temp_seq * surv_mean_ppt$ppt[surv_mean_ppt$Sex==s] * surv_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
...
with(zpoar_surv_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(cvppt_seq,invlogit(mean(surv_coefsa$b0_s) + 
                        ...
                        mean(surv_coefsa$bppttempsex_s) * surv_mean_temp$temp[surv_mean_temp$Sex==s]  * surv_mean_ppt$ppt[surv_mean_ppt$Sex==s] * cvppt_seq * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
...
with(zpoar_surv_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(ppt_seq,invlogit(mean(surv_coefsp$b0_s) + 
                        ...
                        mean(surv_coefsp$bppttempsex_s) * ppt_seq * surv_mean_temp$temp[surv_mean_temp$Sex==s] * surv_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) +
...
with(zpoar_surv_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(temp_seq,invlogit(mean(surv_coefsp$b0_s) + 
                        ...
                        mean(surv_coefsp$bcvpptsex_s) * surv_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) +
                        mean(surv_coefsp$bppttempsex_s) * temp_seq * surv_mean_ppt$ppt[surv_mean_ppt$Sex==s] * surv_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) +
...
saveRDS(fit_allsites_grow_annual, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_growth_annual.rds')
```
...
# plot(loo_grow_annual)
```

## Second  model: annual data with polynomial 2 order
### Running the stan model
```{r , eval=FALSE}
fit_allsites_grow_annual_polyn <- stan(
 file = "/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/stan/poar_growth_annualpolynomial.stan",
 data = poar_sites_annual.grow,
 warmup = sim_pars$warmup,
 iter = sim_pars$iter,
 thin = sim_pars$thin,
...
saveRDS(fit_allsites_grow_annual_polyn, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_growth_annualpolynomial.rds')
```

```{r}
traceplot(fit_allsites_grow_annual_polyn, pars = c("b0_g", "bsize_g","bsex_g","bppt_g","btemp_g","bcvppt_g","bpptsex_g","btempsex_g","bcvpptsex_g","bppttempsex_g","bppt2_g","btemp2_g","bcvppt2_g","bppt2sex_g","btemp2sex_g","bcvppt2sex_g"), inc_warmup = TRUE, nrow =9 )
```

```{r}
log_lik_grow_annual_polyn <- loo::extract_log_lik(fit_allsites_grow_annual_polyn, merge_chains = FALSE)
r_eff_grow_annual_polyn <- loo::relative_eff(exp(log_lik_grow_annual_polyn))
loo_grow_annual_polyn <- loo::loo(log_lik_grow_annual_polyn, r_eff = r_eff_grow_annual_polyn, cores = 2)
# print(loo_grow_annual_polyn)
# plot(loo_grow_annual_polyn)
```
...
saveRDS(fit_allsites_grow_season, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_growth_season.rds')
```
...
saveRDS(fit_allsites_grow_season_polyn, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_growth_seasonpolynomial.rds')
```

```{r}
traceplot(fit_allsites_grow_season_polyn, pars = c("b0_g", "bsize_g","bpptgrow_g","bpptdorm_g","btempgrow_g","btempdorm_g","bpptgrowsex_g","bpptdormsex_g","btempgrowsex_g","btempdormsex_g","btempdormpptdormsex_g","btempgrowpptgrowsex_g","bpptgrow2_g","bpptdorm2_g","btempgrow2_g","btempdorm2_g","bpptgrow2sex_g","bpptdorm2sex_g","btempgrow2sex_g","btempdorm2sex_g"), inc_warmup = TRUE, nrow =15 )
...
color_scheme_set("blue")
mcmc_intervals(posteriorgrowannual_polyn, pars = c("b0_g", "bsize_g","bsex_g","bppt_g","btemp_g","bcvppt_g","bpptsex_g","btempsex_g","bcvpptsex_g","bppttempsex_g","bppt2_g","btemp2_g","bcvppt2_g","bppt2sex_g","btemp2sex_g","bcvppt2sex_g"))+ geom_vline(xintercept = 0, linetype = 2)+theme_bw()
```
...
```{r}
#pull out parameter posterior distributions
predGA <- rstan::extract(fit_allsites_grow_annual, pars = c("predG"))$predG
predGPA <- rstan::extract(fit_allsites_grow_annual_polyn, pars = c("predG"))$predG
...
sigmaGA <- rstan::extract(fit_allsites_grow_annual, pars = c("sigma"))$sigma
sigmaGPA <- rstan::extract(fit_allsites_grow_annual_polyn, pars = c("sigma"))$sigma
...
#draw 500 random samples from the joint posterior
n_post_draws <- 500
post_draws <- sample.int(dim(predGA)[1], n_post_draws)
#set up simulation output
y_ga_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.grow$y_g))
y_gpa_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.grow$y_g))
...
for(i in 1:n_post_draws){
  ...
  ## sample growth data (zero-truncated PIG) -- generates data as legit PIG
    for(j in 1:length(poar_sites_annual.grow$y_g)){
      ## the pig function appears numerically unstable at low probabilities, so here is a hacky solution
      pig<-dpoisinvgauss(0:1000,mean=predGA[i,j],shape=(sigmaGA[i]*predGA[i,j]))
      pig[is.nan(pig) | is.infinite(pig)] <- 0
      pig_trunc_prob <- pig[2:1001] / (1 - ((1 - sum(pig)) + pig[1]))
      y_ga_sim[i,j] <- sample(x=1:1000,size=1,replace=T,prob=pig_trunc_prob)
    } 
  ## sample growth data (zero-truncated PIG) -- generates data as legit PIG
    for(j in 1:length(poar_sites_annual.grow$y_g)){
      ## the pig function appears numerically unstable at low probabilities, so here is a hacky solution
      pig<-dpoisinvgauss(0:1000,mean=predGPA[i,j],shape=(sigmaGPA[i]*predGPA[i,j]))
      pig[is.nan(pig) | is.infinite(pig)] <- 0
      pig_trunc_prob <- pig[2:1001] / (1 - ((1 - sum(pig)) + pig[1]))
      y_gpa_sim[i,j] <- sample(x=1:1000,size=1,replace=T,prob=pig_trunc_prob)
    } 
  ## sample growth data (zero-truncated PIG) -- generates data as legit PIG
...
```{r}
ppc_dens_overlay(poar_sites_annual.grow$y_g, y_ga_sim)+
  xlab("Growth  status")+ylab("Density")+
  ggtitle(("Annual"))+theme(legend.position = "none")->ppc_grow_annual

ppc_dens_overlay(poar_sites_annual.grow$y_g, y_gpa_sim)+
  xlab("Growth status")+ylab("Density")+
  ggtitle(("Annual Polynomial"))+theme(legend.position = "none")->ppc_grow_annualpolyn


ppc_dens_overlay(poar_sites_season.grow$y_g, y_gs_sim)+
  xlab("Growth status")+ylab("Density")+
  ggtitle(("Seasonal"))+theme(legend.position = "none")->ppc_grow_season


ppc_dens_overlay(poar_sites_season.grow$y_g, y_gps_sim)+
  xlab("Growth status")+ylab("Density")+
  ggtitle(("Seasonal Polynomial"))+theme(legend.position = "none")->ppc_grow_season_polyn
...
grow_coefgs <- rstan::extract(fit_allsites_grow_season, c("b0_g","bsex_g", "bsize_g","bpptgrow_g","bpptdorm_g","btempgrow_g","btempdorm_g","bpptgrowsex_g","bpptdormsex_g","btempgrowsex_g","btempdormsex_g","btempdormpptdormsex_g","btempgrowpptgrowsex_g"))
...
with(zpoar_grow_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(ppt_seq,exp(mean(grow_coefgp$b0_g) + 
                        ...
                        mean(grow_coefgp$bppttempsex_g) * ppt_seq * grow_mean_temp$temp[grow_mean_temp$Sex==s] * grow_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) +
...
with(zpoar_grow_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(cvppt_seq,exp(mean(grow_coefgp$b0_g) + 
                        ...
                        mean(grow_coefgp$bppttempsex_g) * grow_mean_temp$temp[grow_mean_temp$Sex==s]  * surv_mean_ppt$ppt[surv_mean_ppt$Sex==s] * cvppt_seq * (s-1) +
                        mean(grow_coefgp$bppt2_g) * (grow_mean_ppt$ppt[grow_mean_ppt$Sex==s])^2 +
                        mean(grow_coefgp$btemp2_g) * (grow_mean_temp$temp[grow_mean_temp$Sex==s])^2 +
...
with(zpoar_grow_plot_season,{
    plot(tempgrow,mean_grow,
         xlab=" Temperature growing",ylab=" Pr Growth");box()
    for(s in 1:2){
...
with(zpoar_grow_plot_season,{
    ...
    for(s in 1:2){
      ...
      lines(pptdorm_seq,exp(mean(grow_coefgsp$b0_g) + 
                        ...
                        mean(grow_coefgsp$btempgrowpptgrowsex_g) * grow_mean_pptgrow$pptgrow[grow_mean_pptgrow$Sex==s]  * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s]  * (s-1) +
                        mean(grow_coefgsp$bpptgrow2_g) * (grow_mean_pptgrow$pptgrow[grow_mean_pptgrow$Sex==s])^2 +
...
saveRDS(fit_allsites_flow_annual, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_flow_annual.rds')
...
### Running the stan model
```{r , eval=FALSE}
fit_allsites_flow_annual_polyn <- stan(
 file = "/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/stan/poar_flow_annualpolynomial.stan",
 data = poar_sites_annual.flow,
 warmup = sim_pars$warmup,
 iter = sim_pars$iter,
 thin = sim_pars$thin,
...
saveRDS(fit_allsites_flow_annual_polyn, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_flow_annualpolynomial.rds')
```

```{r}
traceplot(fit_allsites_flow_annual_polyn, pars = c("b0_f", "bsize_f","bsex_f","bppt_f","btemp_f","bcvppt_f","bpptsex_f","btempsex_f","bcvpptsex_f","bppttempsex_f","bppt2_f","btemp2_f","bcvppt2_f","bppt2sex_f","btemp2sex_f","bcvppt2sex_f"), inc_warmup = TRUE, nrow =9 )
```

```{r}
log_lik_flow_annual_polyn <- loo::extract_log_lik(fit_allsites_flow_annual_polyn, merge_chains = FALSE)
r_eff_flow_annual_polyn <- loo::relative_eff(exp(log_lik_flow_annual_polyn))
loo_flow_annual_polyn <- loo(log_lik_flow_annual_polyn, r_eff = r_eff_flow_annual_polyn, cores = 2)
# print(loo_flow_annual_polyn)
# plot(loo_surv_annual)
```
...
saveRDS(fit_allsites_flow_season, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_flow_season.rds')
```
...
saveRDS(fit_allsites_flow_season_polyn, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_flow_seasonpolynomial.rds')
```

```{r}
traceplot(fit_allsites_flow_season_polyn, pars = c("b0_f", "bsize_f","bpptgrow_f","bpptdorm_f","btempgrow_f","btempdorm_f","bpptgrowsex_f","bpptdormsex_f","btempgrowsex_f","btempdormsex_f","btempdormpptdormsex_f","btempgrowpptgrowsex_f","bpptgrow2_f","bpptdorm2_f","btempgrow2_f","btempdorm2_f","bpptgrow2sex_f","bpptdorm2sex_f","btempgrow2sex_f","btempdorm2sex_f"), inc_warmup = TRUE, nrow =15 )
...
```{r}
#pull out parameter posterior distributions
predFA <- rstan::extract(fit_allsites_flow_annual, pars = c("predF"))$predF
predFPA <- rstan::extract(fit_allsites_flow_annual_polyn, pars = c("predF"))$predF
...
# post_draws <- sample.int(dim(predSA)[1], n_post_draws)
#set up simulation output
y_fa_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.flow$y_f))
y_fpa_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.flow$y_f))
...
for(i in 1:n_post_draws){
  print(i)
  ## sample survival data (bernoulli)
  y_fa_sim [i,] <- rbinom(n=length(poar_sites_annual.flow$y_f), size=1, prob = invlogit(predFA[i,]))
  ## sample flowering data (bernoulli)
  y_fpa_sim[i,] <- rbinom(n=length(poar_sites_annual.flow$y_f), size=1, prob = invlogit(predFPA[i,]))
  ## sample survival data (bernoulli)
...
# plot ppc overlay for survival
```{r}
ppc_dens_overlay(poar_sites_annual.flow$y_f, y_fa_sim)+
  xlab("Flowering status")+ylab("Density")+
  ggtitle(("Annual"))+theme(legend.position = "none")->ppc_flow_annual

ppc_dens_overlay(poar_sites_annual.flow$y_f, y_fpa_sim)+
  xlab("Flowering status")+ylab("Density")+
  ggtitle(("Annual Polynomial"))+theme(legend.position = "none")->ppc_flow_annualpolyn


ppc_dens_overlay(poar_sites_season.flow$y_f, y_fs_sim)+
  xlab("Flowering status")+ylab("Density")+
  ggtitle(("Seasonal"))+theme(legend.position = "none")->ppc_flow_season


ppc_dens_overlay(poar_sites_season.flow$y_f, y_fps_sim)+
  xlab("Flowering status")+ylab("Density")+
  ggtitle(("Seasonal Polynomial"))+theme(legend.position = "none")->ppc_flow_season_polyn
...
with(zpoar_flow_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(cvppt_seq,invlogit(mean(flow_coeffa$b0_f) + 
                        ...
                        mean(flow_coeffa$bppttempsex_f) * flow_mean_temp$temp[flow_mean_temp$Sex==s]  * flow_mean_ppt$ppt[surv_mean_ppt$Sex==s] * cvppt_seq * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
...
with(zpoar_flow_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(ppt_seq,invlogit(mean(flow_coeffp$b0_f) + 
                        ...
                        mean(flow_coeffp$bppttempsex_f) * ppt_seq * flow_mean_temp$temp[flow_mean_temp$Sex==s] * flow_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) +
...
with(zpoar_flow_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(temp_seq,invlogit(mean(flow_coeffp$b0_f) + 
                        ...
                        mean(flow_coeffp$bcvpptsex_f) * flow_mean_cv_ppt$cv_ppt[flow_mean_cv_ppt$Sex==s] * (s-1) +
                        mean(flow_coeffp$bppttempsex_f) * temp_seq * flow_mean_ppt$ppt[flow_mean_ppt$Sex==s] * flow_mean_cv_ppt$cv_ppt[surv_mean_cv_ppt$Sex==s] * (s-1) +
...
with(zpoar_flow_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(cvppt_seq,invlogit(mean(flow_coeffp$b0_f) + 
                        ...
                        mean(flow_coeffp$bppttempsex_f) * flow_mean_temp$temp[flow_mean_temp$Sex==s]  * flow_mean_ppt$ppt[surv_mean_ppt$Sex==s] * cvppt_seq * (s-1) +
                        mean(flow_coeffp$bppt2_f) * (flow_mean_ppt$ppt[flow_mean_ppt$Sex==s])^2 +
                        mean(flow_coeffp$btemp2_f) * (flow_mean_temp$temp[flow_mean_temp$Sex==s])^2 +
...
with(zpoar_flow_plot_season,{
    ...
    for(s in 1:2){
      ...
      lines(tempdorm_seq,invlogit(mean(flow_coeffs$b0_f) + 
                        ...
                        mean(flow_coeffs$btempdormpptdormsex_f) * tempdorm_seq * flow_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s] * (s-1) +
...
with(zpoar_flow_plot_season,{
    ...
    for(s in 1:2){
      ...
      lines(tempdorm_seq,invlogit(mean(flow_coeffsp$b0_f) + 
                        ...
                        mean(flow_coeffsp$btempgrowpptgrowsex_f) * flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s] * flow_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]   * (s-1) +
                        mean(flow_coeffsp$bpptgrow2_f) * (flow_mean_pptgrow$pptgrow[flow_mean_pptgrow$Sex==s])^2 +
                        mean(flow_coeffsp$bpptdorm2_f) * (flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s])^2 +
                        mean(flow_coeffsp$btempgrow2_f) * (flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s])^2 +
...
saveRDS(fit_allsites_panic_annual, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_panicle_annual.rds')
```

```{r}
traceplot(fit_allsites_panic_annual, pars = c("b0_p", "bsize_p","bsex_p","bppt_p","btemp_p","bcvppt_p","bpptsex_p","btempsex_p","bcvpptsex_p","bppttempsex_p"), inc_warmup = TRUE, nrow = 4)
```
...
```{r , eval=FALSE}
fit_allsites_panic_annual_polyn <- stan(
 file = "/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/stan/poar_panicle_annualpolynomial.stan",
 data = poar_sites_annual.panic,
 warmup = sim_pars$warmup,
 iter = sim_pars$iter,
 thin = sim_pars$thin,
...
saveRDS(fit_allsites_panic_annual_polyn, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_panicle_annualpolynomial.rds')
```

```{r}
traceplot(fit_allsites_panic_annual_polyn, pars = c("b0_p", "bsize_p","bsex_p","bppt_p","btemp_p","bcvppt_p","bpptsex_p","btempsex_p","bcvpptsex_p","bppttempsex_p","bppt2_p","btemp2_p","bcvppt2_p","bppt2sex_p","btemp2sex_p","bcvppt2sex_p"), inc_warmup = TRUE, nrow = 5)
```

```{r}
log_lik_panic_annual_polyn <- loo::extract_log_lik(fit_allsites_panic_annual_polyn, merge_chains = FALSE)
r_eff_panic_annual_polyn <- loo::relative_eff(exp(log_lik_panic_annual_polyn))
loo_panic_annual_polyn <- loo::loo(log_lik_panic_annual_polyn, r_eff = r_eff_panic_annual_polyn, cores = 2)
# print(loo_panic_annual_polyn)
# plot(loo_panic_annual_polyn)
```
...
saveRDS(fit_allsites_panic_season, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Modeloutput/poar_panicle_season.rds')

```

```{r}
traceplot(fit_allsites_panic_season, pars = c("b0_p", "bsize_p","bpptgrow_p","bpptdorm_p","btempgrow_p","btempdorm_p","bpptgrowsex_p","bpptdormsex_p","btempgrowsex_p","btempdormsex_p","btempdormpptdormsex_p","btempgrowpptgrowsex_p"), inc_warmup = TRUE, nrow =5 )
```
...
```{r}
#pull out parameter posterior distributions
predPA <- rstan::extract(fit_allsites_panic_annual, pars = c("predP"))$predP
predPPA <- rstan::extract(fit_allsites_panic_annual_polyn, pars = c("predP"))$predP
...
phi_PA <- rstan::extract(fit_allsites_panic_annual, pars = c("phi_p"))$phi_p
phi_PPA <- rstan::extract(fit_allsites_panic_annual_polyn, pars = c("phi_p"))$phi_p
...
#set up simulation output
y_pa_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.panic$y_p))
y_ppa_sim <- matrix(NA,n_post_draws,length(poar_sites_annual.panic$y_p))
...
for(i in 1:n_post_draws){
  ...
  for(j in 1:length(poar_sites_annual.panic$y_p)){
    y_pa_sim[i,j] <- sample(x=1:1000,size=1,replace=T,prob=dnbinom(1:1000, mu = exp(predPA[i,j]), size=phi_PA[i]) / (1 - dnbinom(0, mu = exp(predPA[i,j]), size=phi_PA[i])))
  }
  ## sample panicle data (zero-truncated NB)
  for(j in 1:length(poar_sites_annual.panic$y_p)){
    y_ppa_sim[i,j] <- sample(x=1:1000,size=1,replace=T,prob=dnbinom(1:1000, mu = exp(predPPA[i,j]), size=phi_PPA[i]) / (1 - dnbinom(0, mu = exp(predPPA[i,j]), size=phi_PPA[i])))
  }
  ## sample panicle data (zero-truncated NB)
...
## plot ppc overlay for  growth
```{r}
ppc_dens_overlay(poar_sites_annual.panic$y_p, y_pa_sim)+
  xlab("Number of panicles")+ylab("Density")+
  ggtitle(("Annual"))+theme(legend.position = "none")->ppc_panic_annual

ppc_dens_overlay(poar_sites_annual.panic$y_p, y_ppa_sim)+
  xlab("Number of panicles")+ylab("Density")+
  ggtitle(("Annual Polynomial"))+theme(legend.position = "none")->ppc_panic_annualpolyn


ppc_dens_overlay(poar_sites_season.panic$y_p, y_ps_sim)+
  xlab("Number of panicles")+ylab("Density")+
  ggtitle(("Seasonal"))+theme(legend.position = "none")->ppc_panic_season


ppc_dens_overlay(poar_sites_season.panic$y_p, y_pps_sim)+
  xlab("Number of panicles")+ylab("Density")+
  ggtitle(("Seasonal Polynomial"))+theme(legend.position = "none")->ppc_panic_season_polyn

# print figure
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Figures/PPCFertility.pdf",useDingbats = F,height=7,width=6)
multiplot(ppc_panic_annual,ppc_panic_annualpolyn,ppc_panic_season,
...
with(zpoar_panic_plot_annual,{
    ...
    for(s in 1:2){
      ...
      lines(temp_seq,exp(mean(panic_coefpa$b0_p) + 
                        ...
                        mean(panic_coefpa$bcvpptsex_p) * panic_mean_cv_ppt$cv_ppt[panic_mean_cv_ppt$Sex==s] * (s-1) +
                        mean(panic_coefpa$bppttempsex_p) * temp_seq * grow_mean_ppt$ppt[panic_mean_ppt$Sex==s] * panic_mean_cv_ppt$cv_ppt[panic_mean_cv_ppt$Sex==s] * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
...
with(zpoar_panic_plot_season,{
    ...
    for(s in 1:2){
      ...
      lines(tempgrow_seq,exp(mean(panic_coefpsp$b0_p) + 
                        ...
                        mean(panic_coefpsp$btempdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * (s-1) +
                        mean(panic_coefpsp$btempdormpptdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s] * (s-1) +
                        mean(panic_coefpsp$btempgrowpptgrowsex_p) * tempgrow_seq * grow_mean_tempgrow$tempgrow[grow_mean_tempgrow$Sex==s]  * (s-1) +
...
with(zpoar_panic_plot_season,{
    ...
    for(s in 1:2){
      ...
      lines(tempdorm_seq,exp(mean(panic_coefpsp$b0_p) + 
                        ...
                        mean(panic_coefpsp$bpptgrow2_p) * (panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s])^2 +
                        mean(panic_coefpsp$bpptdorm2_p) * (panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s])^2 +
                        mean(panic_coefpsp$btempgrow2_p) * (grow_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s])^2 +
