...
```{r}
traceplot(fit_allsites_surv_season, pars = c("b0_s","bsizesex_s","btempdormpptdorm_s","btempgrowpptgrow_s","bsex_s", "bsize_s","bpptgrow_s","bpptdorm_s","btempgrow_s","btempdorm_s","bpptgrowsex_s","bpptdormsex_s","btempgrowsex_s","btempdormsex_s","btempdormpptdormsex_s","btempgrowpptgrowsex_s"), inc_warmup = TRUE, nrow =15 )
```
...
## Second  model: seasonnal data with polynomial second order
### Running the stan model
```{r , eval=FALSE}
...
zpoar_surv_plot_season<-scale(poar_surv_plot_season[,6:13])
zpoar_surv_plot_season<-data.frame(poar_surv_plot_season[,1:5],zpoar_surv_plot_season)
zpoar_surv_plot_season$mean_size<-log(zpoar_surv_plot_season$mean_size)
...
#       points(tempgrow[Sex==s],mean_surv[Sex==s],
#              bg=sex_cols[s],pch=21,cex=2)
#       lines(tempgrow_seq,invlogit(mean(surv_coefssp$b0_s) + 
#                         mean(surv_coefssp$bsize_s) * surv_mean_sizesseason$size[surv_mean_sizesseason$Sex==s] +
#                         mean(surv_coefssp$bsizesex_s) * surv_mean_sizesseason$size[surv_mean_sizesseason$Sex==s] * (s-1) +
#                         mean(surv_coefssp$bsex_s) * (s-1) +
#                         mean(surv_coefssp$bpptgrow_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]  +
#                         mean(surv_coefssp$bpptdorm_s) * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s]  +
#                         mean(surv_coefssp$btempgrow_s) * tempgrow_seq +
#                         mean(surv_coefssp$btempdorm_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] +
#                         mean(surv_coefssp$bpptgrowsex_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s] * (s-1) +
#                         mean(surv_coefssp$bpptdormsex_s) * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s]  * (s-1) +
#                         mean(surv_coefssp$btempdormpptdorm_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s] +
#                         mean(surv_coefssp$btempgrowpptgrow_s) * tempgrow_seq * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s] +
#                         mean(surv_coefssp$btempgrowsex_s) * tempgrow_seq * (s-1) +
#                         mean(surv_coefssp$btempdormsex_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] * (s-1) +
#                         mean(surv_coefssp$btempdormpptdormsex_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s] * (s-1) +
#                         mean(surv_coefssp$btempgrowpptgrowsex_s) * tempgrow_seq * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s]  * (s-1) +
...
#       points(pptdorm[Sex==s],mean_surv[Sex==s],
#              bg=sex_cols[s],pch=21,cex=2)
#       lines(pptdorm_seq,invlogit(mean(surv_coefssp$b0_s) + 
#                         mean(surv_coefssp$bsize_s) * surv_mean_sizesseason$size[surv_mean_sizesseason$Sex==s] +
#                         mean(surv_coefssp$bsizesex_s) * surv_mean_sizesseason$size[surv_mean_sizesseason$Sex==s] * (s-1) +
#                         mean(surv_coefssp$bsex_s) * (s-1) +
#                         mean(surv_coefssp$bpptgrow_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]  +
#                         mean(surv_coefssp$bpptdorm_s) * pptdorm_seq +
#                         mean(surv_coefssp$btempgrow_s) * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s] +
#                         mean(surv_coefssp$btempdorm_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] +
#                         mean(surv_coefssp$btempdormpptdorm_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] * pptdorm_seq  +
#                         mean(surv_coefssp$btempgrowpptgrow_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]  * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s] +
#                         mean(surv_coefssp$bpptgrowsex_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]  * (s-1) +
#                         mean(surv_coefssp$bpptdormsex_s) * pptdorm_seq  * (s-1) +
#                         mean(surv_coefssp$btempgrowsex_s) * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s] * (s-1) +
#                         mean(surv_coefssp$btempdormsex_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] * (s-1) +
#                         mean(surv_coefssp$btempdormpptdormsex_s) * surv_mean_tempdorm$tempdorm[surv_mean_tempdorm$Sex==s] * pptdorm_seq * (s-1) +
#                         mean(surv_coefssp$btempgrowpptgrowsex_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]  * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s]  * (s-1) +
#                         mean(surv_coefssp$bpptgrow2_s) * (surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s])^2 +
...
#       points(tempdorm[Sex==s],mean_surv[Sex==s],
#              bg=sex_cols[s],pch=21,cex=2)
#       lines(tempdorm_seq,invlogit(mean(surv_coefssp$b0_s) + 
#                         mean(surv_coefssp$bsize_s) * surv_mean_sizesseason$size[surv_mean_sizesseason$Sex==s] +
#                         mean(surv_coefssp$bsizesex_s) * surv_mean_sizesseason$size[surv_mean_sizesseason$Sex==s] * (s-1) +
#                         mean(surv_coefssp$bsex_s) * (s-1) +
#                         mean(surv_coefssp$bpptgrow_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]  +
#                         mean(surv_coefssp$bpptdorm_s) * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s]  +
#                         mean(surv_coefssp$btempgrow_s) * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s] +
#                         mean(surv_coefssp$btempdorm_s) * tempdorm_seq +
#                         mean(surv_coefssp$btempdormpptdorm_s) * tempdorm_seq * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s] +
#                         mean(surv_coefssp$btempgrowpptgrow_s) * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s] * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s] +
#                         mean(surv_coefssp$bpptgrowsex_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s] * (s-1) +
#                         mean(surv_coefssp$bpptdormsex_s) * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s]  * (s-1) +
#                         mean(surv_coefssp$btempgrowsex_s) * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s] * (s-1) +
#                         mean(surv_coefssp$btempdormsex_s) * tempdorm_seq * (s-1) +
#                         mean(surv_coefssp$btempdormpptdormsex_s) * tempdorm_seq * surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s] * (s-1) +
#                         mean(surv_coefssp$btempgrowpptgrowsex_s) * surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s] * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s]   * (s-1) +
#                         mean(surv_coefssp$bpptgrow2_s) * (surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s])^2 +
#                         mean(surv_coefssp$bpptdorm2_s) * (surv_mean_pptdorm$pptdorm[surv_mean_pptdorm$Sex==s])^2 +
#                         mean(surv_coefssp$btempgrow2_s) * (surv_mean_tempgrow$tempgrow[surv_mean_tempgrow$Sex==s])^2 +
...
zpoar_grow_plot_season<-scale(poar_grow_plot_season[,6:13])
zpoar_grow_plot_season<-data.frame(poar_grow_plot_season[,1:5],zpoar_grow_plot_season)
zpoar_grow_plot_season$mean_size<-log(zpoar_grow_plot_season$mean_size)
...
zpoar_flow_plot_season<-scale(poar_flow_plot_season[,6:13])
zpoar_flow_plot_season<-data.frame(poar_flow_plot_season[,1:5],zpoar_flow_plot_season)
zpoar_flow_plot_season$mean_size<-log(zpoar_flow_plot_season$mean_size)
...
#load stan output -- this will also take a while, but not as long as running the model from scratch
fit_allsites_panic_season_polyn <- readRDS(url("https://www.dropbox.com/scl/fi/fk2xfh57ao6knpu69aamm/poar_panicle_seasonpolynomial.rds?rlkey=p8tpilkzx3vabnp1qk8up6aud&dl=1"))
#ignore warning from readRDS
...
zpoar_panic_plot_season<-scale(poar_panic_plot_season[,6:13])
zpoar_panic_plot_season<-data.frame(poar_panic_plot_season[,1:5],zpoar_panic_plot_season)
zpoar_panic_plot_season$mean_size<-log(zpoar_panic_plot_season$mean_size)
...
with(zpoar_panic_plot_season,{
    ...
    for(s in 1:2){
      points(pptgrow[Sex==s],mean_panic[Sex==s],
             bg=sex_cols[s],pch=21,cex=2)
      lines(pptgrow_seq,exp(mean(panic_coefps$b0_p) + 
                        mean(panic_coefps$bsize_p) * panic_mean_sizesseason$size[panic_mean_sizesseason$Sex==s] +
                         mean(panic_coefps$bsizesex_p) * panic_mean_sizesseason$size[panic_mean_sizesseason$Sex==s]* (s-1)  +
                        mean(panic_coefps$bsex_p) * (s-1) +
                        mean(panic_coefps$bpptgrow_p) * pptgrow_seq +
                        mean(panic_coefps$bpptdorm_p) * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s]  +
                        mean(panic_coefps$btempgrow_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] +
                        mean(panic_coefps$btempdorm_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] +
                        mean(panic_coefps$bpptgrowsex_p) * pptgrow_seq * (s-1) +
                        mean(panic_coefps$bpptdormsex_p) * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s]  * (s-1) +
                        mean(panic_coefps$btempgrowsex_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] * (s-1) +
                        mean(panic_coefps$btempdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * (s-1) +
                        mean(panic_coefps$btempdormpptdorm_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s] * (s-1) +
                        mean(panic_coefps$btempgrowpptgrow_p) * pptgrow_seq * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s]  * (s-1) +
                        mean(panic_coefps$btempdormpptdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s] * (s-1) +
                        mean(panic_coefps$btempgrowpptgrowsex_p) * pptgrow_seq * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s]  * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
...
with(zpoar_panic_plot_season,{
    ...
    for(s in 1:2){
      points(tempgrow[Sex==s],mean_panic[Sex==s],
             bg=sex_cols[s],pch=21,cex=2)
      lines(tempgrow_seq,exp(mean(panic_coefps$b0_p) + 
                        mean(panic_coefps$bsize_p) * panic_mean_sizesseason$size[panic_mean_sizesseason$Sex==s]* (s-1)  +
                        mean(panic_coefps$bsex_p) * (s-1) +
                        mean(panic_coefps$bpptgrow_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]  +
                        mean(panic_coefps$bpptdorm_p) * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s]  +
                        mean(panic_coefps$btempgrow_p) * tempgrow_seq +
                        mean(panic_coefps$btempdorm_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] +
                        mean(panic_coefps$bpptgrowsex_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s] * (s-1) +
                        mean(panic_coefps$bpptdormsex_p) * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s]  * (s-1) +
                        mean(panic_coefps$btempgrowsex_p) * tempgrow_seq * (s-1) +
                        mean(panic_coefps$btempdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * (s-1) +
                        mean(panic_coefps$btempdormpptdorm_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s] +
                        mean(panic_coefps$btempgrowpptgrow_p) * tempgrow_seq * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s]  +
                        mean(panic_coefps$btempdormpptdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s] * (s-1) +
                        mean(panic_coefps$btempgrowpptgrowsex_p) * tempgrow_seq * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s]  * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
...
with(zpoar_panic_plot_season,{
    ...
    for(s in 1:2){
      points(pptdorm[Sex==s],mean_panic[Sex==s],
             bg=sex_cols[s],pch=21,cex=2)
      lines(pptdorm_seq,exp(mean(panic_coefps$b0_p) + 
                        mean(panic_coefps$bsize_p) * panic_mean_sizesseason$size[panic_mean_sizesseason$Sex==s] +
                        mean(panic_coefps$bsizesex_p) * panic_mean_sizesseason$size[panic_mean_sizesseason$Sex==s] * (s-1) +
                        mean(panic_coefps$bsex_p) * (s-1) +
                        mean(panic_coefps$bpptgrow_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]  +
                        mean(panic_coefps$bpptdorm_p) * pptdorm_seq +
                        mean(panic_coefps$btempgrow_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] +
                        mean(panic_coefps$btempdorm_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] +
                        mean(panic_coefps$bpptgrowsex_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]  * (s-1) +
                        mean(panic_coefps$bpptdormsex_p) * pptdorm_seq  * (s-1) +
                        mean(panic_coefps$btempgrowsex_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] * (s-1) +
                        mean(panic_coefps$btempdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * (s-1) +
                        mean(panic_coefps$btempdormpptdorm_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * pptdorm_seq  +
                        mean(panic_coefps$btempgrowpptgrow_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]  * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s]  + 
                        mean(panic_coefps$btempdormpptdormsex_p) * panic_mean_tempdorm$tempdorm[panic_mean_tempdorm$Sex==s] * pptdorm_seq * (s-1) +
                        mean(panic_coefps$btempgrowpptgrowsex_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]  * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s]  * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
...
with(zpoar_panic_plot_season,{
    ...
    for(s in 1:2){
      points(tempdorm[Sex==s],mean_panic[Sex==s],
             bg=sex_cols[s],pch=21,cex=2)
      lines(tempdorm_seq,exp(mean(panic_coefps$b0_p) + 
                        mean(panic_coefps$bsize_p) * panic_mean_sizesseason$size[panic_mean_sizesseason$Sex==s] +
                        mean(panic_coefps$bsizesex_p) * panic_mean_sizesseason$size[panic_mean_sizesseason$Sex==s] * (s-1) +
                        mean(panic_coefps$bsex_p) * (s-1) +
                        mean(panic_coefps$bpptgrow_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]  +
                        mean(panic_coefps$bpptdorm_p) * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s]  +
                        mean(panic_coefps$btempgrow_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] +
                        mean(panic_coefps$btempdorm_p) * tempdorm_seq +
                        mean(panic_coefps$bpptgrowsex_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s] * (s-1) +
                        mean(panic_coefps$bpptdormsex_p) * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s]  * (s-1) +
                        mean(panic_coefps$btempgrowsex_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] * (s-1) +
                        mean(panic_coefps$btempdormsex_p) * tempdorm_seq * (s-1) +
                        mean(panic_coefps$btempdormpptdorm_p) * tempdorm_seq * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s]  +
                        mean(panic_coefps$btempgrowpptgrow_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]    +
                        mean(panic_coefps$btempdormpptdormsex_p) * tempdorm_seq * panic_mean_pptdorm$pptdorm[panic_mean_pptdorm$Sex==s] * (s-1) +
                        mean(panic_coefps$btempgrowpptgrowsex_p) * panic_mean_tempgrow$tempgrow[panic_mean_tempgrow$Sex==s] * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s]   * (s-1) 
      ),col= sex_cols[s],lwd=3)
    }
})
