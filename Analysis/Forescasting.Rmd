...
# saveRDS(fit_allsites_season, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/fit_allsites_season.rds')

```

```{r}
#load stan output -- this will also take a while, but not as long as running the model from scratch
fit_allsites_season <- readRDS(url("https://www.dropbox.com/scl/fi/rnqmxhcaz3ysmqmc3ipus/fit_allsites_season.rds?rlkey=l92xvp88n2v7s7r8uxcfhsvga&dl=1"))
...
```{r}
traceplot(fit_allsites_season, pars = quote_bare(b0_s,bsizesex_s,btempdormpptdorm_s,btempgrowpptgrow_s,bsex_s,
                                                        ...
                                                        btempgrow2sex_s,btempdorm2sex_s))+theme_bw()
```

```{r}
traceplot(fit_allsites_season, pars = quote_bare(b0_g,btempdormpptdorm_g,btempgrowpptgrow_g,bsizesex_g,bsex_g,
                                                        ...
                                                        btempdorm2_g,bpptgrow2sex_g,bpptdorm2sex_g,btempgrow2sex_g,btempdorm2sex_g))+theme_bw()
```

```{r}
traceplot(fit_allsites_season, pars = quote_bare(b0_f,bsizesex_f,bsex_f, bsize_f,bpptgrow_f,bpptdorm_f,btempgrow_f,
                                                        ...
                                                        btempdorm2_f,bpptgrow2sex_f,bpptdorm2sex_f,btempgrow2sex_f,btempdorm2sex_f))+theme_bw()
```

```{r}
traceplot(fit_allsites_season, pars = quote_bare(b0_p,bsex_p,bsex_p,bsizesex_p, bsize_p,bpptgrow_p,bpptdorm_p,
                                                         ...
                                                         btempdorm2_p,bpptgrow2sex_p,bpptdorm2sex_p,btempgrow2sex_p,btempdorm2sex_p))+theme_bw()
```
...
mcmc_intervals(posteriorsurv_season, pars = quote_bare(b0_s,bsizesex_s,btempdormpptdorm_s,btempgrowpptgrow_s,bsex_s,
                                                        bsize_s,bpptgrow_s,bpptdorm_s,btempgrow_s,btempdorm_s,
                                                        bpptgrowsex_s,bpptdormsex_s,btempgrowsex_s,btempdormsex_s,
                                                        btempdormpptdormsex_s,btempgrowpptgrowsex_s,bpptgrow2_s,
                                                        bpptdorm2_s,btempgrow2_s,btempdorm2_s,bpptgrow2sex_s,bpptdorm2sex_s,
                                                        btempgrow2sex_s,btempdorm2sex_s))+ geom_vline(xintercept = 0, linetype = 2)+theme_bw()
```

```{r}
mcmc_intervals(posteriorsurv_season, pars = quote_bare(b0_g,btempdormpptdorm_g,btempgrowpptgrow_g,bsizesex_g,bsex_g,
                                                        bsize_g,bpptgrow_g,bpptdorm_g,btempgrow_g,btempdorm_g,bpptgrowsex_g,
                                                        bpptdormsex_g,btempgrowsex_g,btempdormsex_g,btempdormpptdormsex_g,
                                                        btempgrowpptgrowsex_g,bpptgrow2_g,bpptdorm2_g,btempgrow2_g,
                                                        btempdorm2_g,bpptgrow2sex_g,bpptdorm2sex_g,btempgrow2sex_g,btempdorm2sex_g))+ geom_vline(xintercept = 0, linetype = 2)+theme_bw()
```

```{r}
mcmc_intervals(posteriorsurv_season, pars = quote_bare(b0_f,bsizesex_f,bsex_f, bsize_f,bpptgrow_f,bpptdorm_f,btempgrow_f,
                                                        btempdorm_f,bpptgrowsex_f,bpptdormsex_f,btempgrowsex_f,btempdormsex_f,
                                                        btempdormpptdorm_f,btempgrowpptgrow_f,btempdormpptdormsex_f,
                                                        btempgrowpptgrowsex_f,bpptgrow2_f,bpptdorm2_f,btempgrow2_f,
                                                        btempdorm2_f,bpptgrow2sex_f,bpptdorm2sex_f,btempgrow2sex_f,btempdorm2sex_f))+ geom_vline(xintercept = 0, linetype = 2)+theme_bw()
```

```{r}
mcmc_intervals(posteriorsurv_season, pars = quote_bare(b0_p,bsex_p,bsex_p,bsizesex_p, bsize_p,bpptgrow_p,bpptdorm_p,
                                                         btempgrow_p,btempdorm_p,bpptgrowsex_p,bpptdormsex_p,btempgrowsex_p,
                                                         btempdormsex_p,btempdormpptdorm_p,btempgrowpptgrow_p,btempdormpptdormsex_p,
                                                         btempgrowpptgrowsex_p,bpptgrow2_p,bpptdorm2_p,btempgrow2_p,
                                                         btempdorm2_p,bpptgrow2sex_p,bpptdorm2sex_p,btempgrow2sex_p,btempdorm2sex_p))+ geom_vline(xintercept = 0, linetype = 2)+theme_bw()
```
...
with(poar_surv_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptgrow_seq ,sex_diff_surv_mean_pptgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(pptgrow_seq ,rev(pptgrow_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptgrow_seq ,sex_diff_surv_mean_pptgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_surv_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempgrow_seq ,sex_diff_surv_mean_tempgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(tempgrow_seq ,rev(tempgrow_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempgrow_seq ,sex_diff_surv_mean_tempgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_surv_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(pptdorm[size_bin==i],mean_surv[size_bin==i],type="n",ylim=c(0,1),
         xlab=" ",ylab=" ",xaxt="n");box()
    # if(i==1){mtext("Pr(survival)",side=2,line=3,cex=1.3)}
    title(LETTERS[i+2],adj=0)
    for(s in 1:2){
      points(pptdorm[Sex==s & size_bin==i],mean_surv[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=5*(bin_n/max(bin_n)),lwd=2)
      lines(pptdorm_seq,invlogit(mean(surv_coef$b0_s) + 
                         mean(surv_coef$bsize_s) * surv_mean_sizes$size[surv_mean_sizes$Sex==s & surv_mean_sizes$size_bin==i]+
                         mean(surv_coef$bsizesex_s) * surv_mean_sizes$size[surv_mean_sizes$Sex==s & surv_mean_sizes$size_bin==i] * (s-1) +
                         mean(surv_coef$bsex_s) * (s-1) +
                         mean(surv_coef$bpptgrow_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s] +
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptdorm_seq ,sex_diff_surv_mean_pptdorm[i,],type="n",lwd=4,yaxt="n",
         xlab=" ",ylab=" ",xaxt="n",ylim=c(min(sex_diff_surv_95_pptdorm[i,,1]),max(sex_diff_surv_95_pptdorm[i,,2])))
    # if(i==1){mtext(expression(paste(Delta," (F-M)")),side=2,line=2,cex=1.3)}
    polygon(x=c(pptdorm_seq,rev(pptdorm_seq )),
    ...
    polygon(x=c(pptdorm_seq ,rev(pptdorm_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptdorm_seq ,sex_diff_surv_mean_pptdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_surv_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(tempdorm[size_bin==i],mean_surv[size_bin==i],type="n",ylim=c(0,1),
         xlab=" ",ylab=" ",xaxt="n");box()
    # if(i==1){mtext("Pr(survival)",side=2,line=3,cex=1.3)}
    title(LETTERS[i+3],adj=0)
    for(s in 1:2){
      points(tempdorm[Sex==s & size_bin==i],mean_surv[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=5*(bin_n/max(bin_n)),lwd=2)
      lines(tempdorm_seq,invlogit(mean(surv_coef$b0_s) + 
                         mean(surv_coef$bsize_s) * surv_mean_sizes$size[surv_mean_sizes$Sex==s & surv_mean_sizes$size_bin==i] +
                         mean(surv_coef$bsizesex_s) * surv_mean_sizes$size[surv_mean_sizes$Sex==s & surv_mean_sizes$size_bin==i] * (s-1) +
                         mean(surv_coef$bsex_s) * (s-1) +
                         mean(surv_coef$bpptgrow_s) * surv_mean_pptgrow$pptgrow[surv_mean_pptgrow$Sex==s] +
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempdorm_seq ,sex_diff_surv_mean_tempdorm[i,],type="n",lwd=4,yaxt="n",
         xlab=" ",ylab=" ",xaxt="n",ylim=c(min(sex_diff_surv_95_tempdorm[i,,1]),max(sex_diff_surv_95_tempdorm[i,,2])))
    # if(i==1){mtext(expression(paste(Delta," (F-M)")),side=2,line=2,cex=1.3)}
    polygon(x=c(tempdorm_seq,rev(tempdorm_seq )),
    ...
    polygon(x=c(tempdorm_seq ,rev(tempdorm_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempdorm_seq ,sex_diff_surv_mean_tempdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_grow_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptgrow_seq ,sex_diff_grow_mean_pptgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(pptgrow_seq ,rev(pptgrow_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptgrow_seq ,sex_diff_grow_mean_pptgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_grow_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempgrow_seq ,sex_diff_grow_mean_tempgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(tempgrow_seq ,rev(tempgrow_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempgrow_seq ,sex_diff_grow_mean_tempgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_grow_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(pptdorm[size_bin==i] ,mean_grow[size_bin==i],type="n",
         xlab=" ",ylab=" ",xaxt="n");box()    
    # if(i==1){mtext("#tillers",side=2,line=3,cex=1.3)}
    title(LETTERS[i+6],adj=0)    
    for(s in 1:2){
      points(pptdorm[Sex==s & size_bin==i] ,mean_grow[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=5*(bin_n/max(bin_n)),lwd=2)
      lines(pptdorm_seq ,
            exp(mean(grow_coef$b0_g) + 
                         mean(grow_coef$bsize_g) * grow_mean_sizes$size[grow_mean_sizes$Sex==s & grow_mean_sizes$size_bin==i]+
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptdorm_seq ,sex_diff_grow_mean_pptdorm[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(pptdorm_seq ,rev(pptdorm_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptdorm_seq ,sex_diff_grow_mean_pptdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_grow_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(tempdorm[size_bin==i] ,mean_grow[size_bin==i],type="n",
         xlab=" ",ylab=" ",xaxt="n");box()    
    # if(i==1){mtext("#tillers",side=2,line=3,cex=1.3)}
    title(LETTERS[i+7],adj=0)    
    for(s in 1:2){
      points(tempdorm[Sex==s & size_bin==i] ,mean_grow[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=5*(bin_n/max(bin_n)),lwd=2)
      lines(tempdorm_seq ,exp(mean(grow_coef$b0_g) + 
                         mean(grow_coef$bsize_g) * grow_mean_sizes$size[grow_mean_sizes$Sex==s & grow_mean_sizes$size_bin==i] +
                         mean(grow_coef$bsizesex_g) * grow_mean_sizes$size[grow_mean_sizes$Sex==s & grow_mean_sizes$size_bin==i] * (s-1) +
                         mean(grow_coef$bsex_g) * (s-1) +
                         mean(grow_coef$bpptgrow_g) * grow_mean_pptgrow$pptgrow[grow_mean_pptgrow$Sex==s] +
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempdorm_seq ,sex_diff_grow_mean_tempdorm[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(tempdorm_seq ,rev(tempdorm_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempdorm_seq ,sex_diff_grow_mean_tempdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_flow_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptgrow_seq ,sex_diff_flow_mean_pptgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(pptgrow_seq ,rev(pptgrow_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptgrow_seq ,sex_diff_flow_mean_pptgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_flow_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempgrow_seq ,sex_diff_flow_mean_tempgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(tempgrow_seq ,rev(tempgrow_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempgrow_seq ,sex_diff_flow_mean_tempgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_flow_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(pptdorm[size_bin==i] ,mean_flow[size_bin==i],type="n",
         xlab=" ",ylab=" ",xaxt="n");box()
    # if(i==1){mtext("Pr(flowering)",side=2,line=3,cex=1.3)}
    title(LETTERS[i+10],adj=0)    
    for(s in 1:2){
      points(pptdorm[Sex==s & size_bin==i],mean_flow[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=5*(bin_n/max(bin_n)),lwd=2)
      lines(pptdorm_seq, invlogit(mean(flow_coef$b0_f) + 
                         mean(flow_coef$bsize_f) * flow_mean_sizes$size[flow_mean_sizes$Sex==s & flow_mean_sizes$size_bin==i]+
                         mean(flow_coef$bsizesex_f) * flow_mean_sizes$size[flow_mean_sizes$Sex==s & flow_mean_sizes$size_bin==i] * (s-1) +
                         mean(flow_coef$bsex_f) * (s-1) +
                         mean(flow_coef$bpptgrow_f) * flow_mean_pptgrow$pptgrow[flow_mean_pptgrow$Sex==s] +
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptdorm_seq ,sex_diff_flow_mean_pptdorm[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(pptdorm_seq ,rev(pptdorm_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptdorm_seq ,sex_diff_flow_mean_pptdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_flow_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(tempdorm[size_bin==i] ,mean_flow[size_bin==i],type="n",
         xlab=" ",ylab=" ",xaxt="n");box()
    # if(i==1){mtext("Pr(flowering)",side=2,line=3,cex=1.3)}
    title(LETTERS[i+11],adj=0)    
    for(s in 1:2){
      points(tempdorm[Sex==s & size_bin==i],mean_flow[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=5*(bin_n/max(bin_n)),lwd=2)
      lines(tempdorm_seq, invlogit(mean(flow_coef$b0_f[post_draws[p]]) + 
                         mean(flow_coef$bsize_f) * flow_mean_sizes$size[flow_mean_sizes$Sex==s & flow_mean_sizes$size_bin==i] +
                         mean(flow_coef$bsizesex_f) * flow_mean_sizes$size[flow_mean_sizes$Sex==s & flow_mean_sizes$size_bin==i] * (s-1) +
                         mean(flow_coef$bsex_f) * (s-1) +
                         mean(flow_coef$bpptgrow_f) * flow_mean_pptgrow$pptgrow[flow_mean_pptgrow$Sex==s] +
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempdorm_seq ,sex_diff_flow_mean_tempdorm[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(tempdorm_seq ,rev(tempdorm_seq)),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempdorm_seq ,sex_diff_flow_mean_tempdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_panic_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptgrow_seq ,sex_diff_panic_mean_pptgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(pptgrow_seq ,rev(pptgrow_seq )),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptgrow_seq ,sex_diff_panic_mean_pptgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_panic_binned,{
  for(i in 1:size_bin_num){
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempgrow_seq ,sex_diff_panic_mean_tempgrow[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(tempgrow_seq ,rev(tempgrow_seq )),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempgrow_seq ,sex_diff_panic_mean_tempgrow[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_panic_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(pptdorm[size_bin==i] ,mean_panic[size_bin==i],type="n",
         xlab=" ",ylab=" ",xaxt="n",ylim=c(0,max(mean_panic[size_bin==i])));box()    
    # if(i==1){mtext("#panicles",side=2,line=3,cex=1.3)}
    title(LETTERS[i+14],adj=0)    
    for(s in 1:2){
      points(pptdorm[Sex==s & size_bin==i],mean_panic[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=7*(bin_n/max(bin_n)),lwd=2)
      lines(pptdorm_seq, exp(mean(panic_coef$b0_p) + 
                         mean(panic_coef$bsize_p) * panic_mean_sizes$size[panic_mean_sizes$Sex==s & panic_mean_sizes$size_bin==i]+
                         mean(panic_coef$bsizesex_p) * panic_mean_sizes$size[panic_mean_sizes$Sex==s & panic_mean_sizes$size_bin==i] * (s-1) +
                         mean(panic_coef$bsex_p) * (s-1) +
    ...
    par(mar=c(2,4,0.5,0))
    plot(pptdorm_seq ,sex_diff_panic_mean_pptdorm[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(pptdorm_seq ,rev(pptdorm_seq )),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(pptdorm_seq ,sex_diff_panic_mean_pptdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
with(poar_panic_binned,{
  for(i in 1:size_bin_num){
    par(mar=c(0,4,1,0))
    plot(tempdorm[size_bin==i] ,mean_panic[size_bin==i],type="n",
         xlab=" ",ylab=" ",xaxt="n",ylim=c(0,max(mean_panic[size_bin==i])));box()    
    # if(i==1){mtext("#panicles",side=2,line=3,cex=1.3)}
    title(LETTERS[i+15],adj=0)    
    for(s in 1:2){
      points(tempdorm[Sex==s & size_bin==i],mean_panic[Sex==s & size_bin==i],
             bg=sex_cols[s],pch=21,cex=7*(bin_n/max(bin_n)),lwd=2)
      lines(tempdorm_seq, exp(mean(panic_coef$b0_p) + 
                         mean(panic_coef$bsize_p) * panic_mean_sizes$size[panic_mean_sizes$Sex==s & panic_mean_sizes$size_bin==i] +
                         mean(panic_coef$bsizesex_p) * panic_mean_sizes$size[panic_mean_sizes$Sex==s & panic_mean_sizes$size_bin==i] * (s-1) +
                         mean(panic_coef$bsex_p) * (s-1) +
                         mean(panic_coef$bpptgrow_p) * panic_mean_pptgrow$pptgrow[panic_mean_pptgrow$Sex==s] +
    ...
    par(mar=c(2,4,0.5,0))
    plot(tempdorm_seq ,sex_diff_panic_mean_tempdorm[i,],type="n",lwd=4,yaxt="n",
    ...
    polygon(x=c(tempdorm_seq ,rev(tempdorm_seq )),
            ...
            col=alpha(diff_col,diff_alpha),border=NA)
    lines(tempdorm_seq ,sex_diff_panic_mean_tempdorm[i,],lwd=2,col="black")
    abline(h=0,lty=2)
    mtext("0",side=2,at=0)
  }
})
...
climat_ppt<-data.frame(pptgrow_seq_extend=pptgrow_seq_extend,tempgrow_seq_extend=rep(mean(poar.clim_seasonal$tempgrow),length(pptgrow_seq_extend)),pptdorm_seq_extend=rep(mean(poar.clim_seasonal$pptdorm),length(pptgrow_seq_extend)),tempdorm_seq_extend=rep(mean(poar.clim_seasonal$tempdorm),length(pptgrow_seq_extend)))
...
for (i in 1:nrow(climat_ppt)) {
  ...
  mat <- megamatrix_delay( F_params=F_params,
                           ...
                           pptdorm=climat_ppt[i,3],
                           tempdorm=climat_ppt[i,4],
                           rfx=rfx_fun())$MEGAmat
...
plot(climat_ppt$pptgrow_seq_extend,lambda_pptgrow_mean,type="l",lwd=2,col=cbPalette[1],
     xlab="Precipitation growing season",ylab=expression(paste(lambda)),cex.lab=1.3,ylim=c(0,8))
...
```{r}
plot(climat_ppt$pptgrow_seq_extend,OSR_pptgrow_mean,type="l",ylim=c(0,1),lwd=4,
     xlab="Precipitation growing season",ylab="Operational sex ratio (fraction female panicles)")
```
...
climat_temp<-data.frame(pptgrow_seq_extend=rep(mean(poar.clim_seasonal$pptgrow),length(pptgrow_seq_extend)),tempgrow_seq_extend=tempgrow_seq_extend,pptdorm_seq_extend=rep(mean(poar.clim_seasonal$pptdorm),length(tempgrow_seq_extend)),tempdorm_seq_extend=rep(mean(poar.clim_seasonal$tempdorm),length(tempgrow_seq_extend)))
...
for (i in 1:nrow(climat_temp)) {
  ...
  mat <- megamatrix_delay( F_params=F_params,
                           ...
                           pptdorm=climat_temp[i,3],
                           tempdorm=climat_temp[i,4],
                           rfx=rfx_fun())$MEGAmat
...
plot(climat_temp$tempgrow_seq_extend,lambda_tempgrow_mean,type="l",lwd=2,col=cbPalette[1],
     xlab="Temperature growing season",ylab=expression(paste(lambda)),cex.lab=1.3,ylim=c(0,2.9))
...
## extend the climatic  to bounds and beyond of observed distribution
## note that length of this vector has a big effect on how fast/slow the following code runs
pptdorm_seq_extend <- seq(min(poar.clim_seasonal$pptdorm),max(poar.clim_seasonal$pptdorm),length.out=20)
climat_pptdorm<-data.frame(pptgrow_seq_extend=rep(mean(poar.clim_seasonal$pptgrow),length(pptdorm_seq_extend)),tempgrow_seq_extend=rep(mean(poar.clim_seasonal$tempgrow),length(pptdorm_seq_extend)),pptdorm_seq_extend=pptdorm_seq_extend,tempdorm_seq_extend=rep(mean(poar.clim_seasonal$tempdorm),length(pptdorm_seq_extend)))
...
for (i in 1:nrow(climat_pptdorm)) {
  ...
  mat <- megamatrix_delay( F_params=F_params,
                           ...
                           fert_perturb=0,
                           viab_perturb=0,
                           pptgrow=climat_pptdorm[i,1],
                           tempgrow=climat_pptdorm[i,2],
                           pptdorm=climat_pptdorm[i,3],
                           tempdorm=climat_pptdorm[i,4],
                           rfx=rfx_fun())$MEGAmat
...
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_precipitation_dorm.pdf",useDingbats = F,height=5,width=6)
par(mar=c(5,5,1,1))
plot(climat_pptdorm$pptdorm_seq_extend,lambda_pptdorm_mean,type="l",lwd=2,col=cbPalette[1],
     xlab="Precipitation dormant season",ylab=expression(paste(lambda)),cex.lab=1.3,ylim=c(0,10))
...
## extend the climatic  to bounds and beyond of observed distribution
## note that length of this vector has a big effect on how fast/slow the following code runs
tempdorm_seq_extend <- seq(min(poar.clim_seasonal$tempdorm),max(poar.clim_seasonal$tempdorm),length.out=20)

climat_tempdorm<-data.frame(pptgrow_seq_extend=rep(mean(poar.clim_seasonal$pptgrow),length(pptgrow_seq_extend)),tempgrow_seq_extend=rep(mean(poar.clim_seasonal$tempgrow),length(pptgrow_seq_extend)),pptdorm_seq_extend=rep(mean(poar.clim_seasonal$pptdorm),length(pptgrow_seq_extend)),tempdorm_seq_extend=tempdorm_seq_extend)
...
for (i in 1:nrow(climat_tempdorm)) {
  ...
  mat <- megamatrix_delay( F_params=F_params,
                           ...
                           fert_perturb=0,
                           viab_perturb=0,
                           pptgrow=climat_tempdorm[i,1],
                           tempgrow=climat_tempdorm[i,2],
                           pptdorm=climat_tempdorm[i,3],
                           tempdorm=climat_tempdorm[i,4],
                           rfx=rfx_fun())$MEGAmat
...
```{r}
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_tem_dorm.pdf",useDingbats = F,height=5,width=6)
par(mar=c(5,5,1,1))
plot(climat_tempdorm$tempdorm_seq_extend,lambda_tempdorm_mean,type="l",lwd=2,col=cbPalette[1],
     xlab="Temperature dormant season",ylab=expression(paste(lambda)),cex.lab=1.3,ylim=c(0,4))
...
climat_dorm_mean<-data.frame(pptdorm_seq_extend=rep(mean(poar.clim_seasonal$pptdorm),nrow(climat_grow)),tempdorm_seq_extend=rep(mean(poar.clim_seasonal$tempdorm),nrow(climat_grow)))
climat_grow_3D<-data.frame(climat_grow,climat_dorm_mean)

lambda_mean_grow<-lambda_mean_grow_2sex<-SR_grow_mean<-OSR_grow_mean<-c()
ssd_grow<-matrix(NA,(F_params$max_size+1)*2,nrow(climat_grow_3D))
max_yrs <- 20

for (i in 1:nrow(climat_grow_3D)) {
    #linear model for comparison
  mat <- megamatrix_delay( F_params=F_params,
                           M_params=M_params,
                           twosex=F,
                           ...
                           fert_perturb=0,
                           viab_perturb=0,
                           pptgrow=climat_grow_3D[i,1],
                           tempgrow=climat_grow_3D[i,2],
                           pptdorm = climat_grow_3D[i,3],
                           tempdorm = climat_grow_3D[i,4],
                           rfx=rfx_fun())$MEGAmat
  lambda_mean_grow[i] <- popbio::lambda(mat)
  # 2-sex model
  lambda_run <- lambdaSim_delay( F_params=F_params,
                                 M_params=M_params,
                                 grow_perturb=0,
...
wireframe(lambda_mean_grow ~ climat_grow_3D$pptgrow_seq_extend + climat_grow_3D$tempgrow_seq_extend,
...
```{r}
mtrx_grow <- matrix(lambda_mean_grow, nrow = 10, dimnames = list(pptgrow_seq_extend,
               tempgrow_seq_extend))
...
climat_grow_mean<-data.frame(pptgrow_seq_extend=rep(mean(poar.clim_seasonal$pptgrow),nrow(climat_dorm)),tempgrow_seq_extend=rep(mean(poar.clim_seasonal$tempgrow),nrow(climat_grow)))
climat_dorm_3D<-data.frame(climat_grow_mean,climat_dorm)

lambda_mean_dorm<-lambda_mean_dorm_2sex<-SR_dorm_mean<-OSR_dorm_mean<-c()
ssd_dorm<-matrix(NA,(F_params$max_size+1)*2,nrow(climat_dorm_3D))
max_yrs <- 20

for (i in 1:nrow(climat_dorm_3D)) {
    #linear model for comparison
  mat <- megamatrix_delay( F_params=F_params,
                           M_params=M_params,
                           twosex=F,
                           ...
                           fert_perturb=0,
                           viab_perturb=0,
                           pptgrow=climat_dorm_3D[i,1],
                           tempgrow=climat_dorm_3D[i,2],
                           pptdorm = climat_dorm_3D[i,3],
                           tempdorm = climat_dorm_3D[i,4],
                           rfx=rfx_fun())$MEGAmat
  lambda_mean_dorm[i] <- popbio::lambda(mat)
  # 2-sex model
  lambda_run <- lambdaSim_delay( F_params=F_params,
                                 M_params=M_params,
                                 grow_perturb=0,
...
# trellis.par.set("axis.line",list(col=NA,lty=1,lwd=1))
par(mfrow = c(1, 2))
wireframe(lambda_mean_dorm ~ climat_dorm_3D$pptdorm_seq_extend + climat_dorm_3D$tempdorm_seq_extend,
          # subset = lambda_grow_mean < 5, 
          zlab = list(expression(paste(lambda)), rot=90),
    drape = TRUE, col.regions = cls, scales = list(arrows = FALSE), 
    par.settings = list(axis.line = list(col = 'transparent')),
...
```{r}
mtrx_dorm <- matrix(lambda_mean_dorm, nrow = 10, dimnames = list(pptdorm_seq_extend,
               tempgdorm_seq_extend))

persp(mtrx_dorm,xlab="Precipitation",ylab="Temperature",zlab=expression(paste(lambda)),
                     theta = 30, phi = 30,col=cls, ticktype = "simple")
```
...
# these are the effects of precipitation of growing season the intercepts and slopes
betas_pptgrow <- c(F_params[c("surv_pptgrow","surv_size","grow_pptgrow","flow_pptgrow","panic_pptgrow")],
               M_params[c("surv_pptgrow","surv_size","grow_pptgrow","flow_pptgrow","panic_pptgrow")])
# these are the effects of precipitation^2 on the intercepts and slopes
betas_pptgrow2 <- c(F_params[c("surv_pptgrow2","surv_size2","grow_pptgrow2","flow_pptgrow2","panic_pptgrow2")],
                M_params[c("surv_pptgrow2","surv_size2","grow_pptgrow2","flow_pptgrow2","panic_pptgrow2")])

## Sensitivity of parameters to  precipitation of the grwoing season -- this is just the derivative of a second-order polynomial
dp_dpptgrow_fun <- function(betas_pptgrow,betas_pptgrow2,pptgrow){return(betas_pptgrow + 2*betas_pptgrow2*pptgrow)}

## loop over pptgrow and calculated dp_dpptgrow and dlambda_dp
dp_dpptgrow <- dlambda_dp <- matrix(NA,nrow=length(LTRE_params)*2,ncol=length(pptgrow_seq_extend))
lambda_pptgrow <- c()
perturbation <- 0.01
for(l in 1:length(pptgrow_seq_extend)){
 lambda_pptgrow[l] <- lambdaSim_delay(F_params=F_params,M_params=M_params,pptgrow=pptgrow_seq_extend[l],rfx=rfx_fun(),max.yrs=max_yrs)$lambdatracker[max_yrs]
