...
#print figure
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_past_present_future.pdf",height = 7,width = 8,useDingbats = F)
...
mtext("Precipitation (grow. season)",side=1,line=1,cex=1.2)
...
mtext("Temperature (grow. season)",side=1,line=1,cex=1.2)
...
plot(all_pptdorm_seq*sd(poar_2015_2016$pptdorm)+mean(poar_2015_2016$pptdorm),lambda_pptdorm_all,ylim=c(0,2.5),
         xlab=" ",ylab=" ",yaxt="n",type="n",xaxt="n",)
mtext("Precipitation (dorm. season)",side=1,line=1,cex=1.2)
...
plot(all_tempdorm_seq*sd(poar_2015_2016$tempdorm)+mean(poar_2015_2016$tempdorm),lambda_tempdorm_all,ylim=c(0,2.5),
         xlab=" ",ylab=" ",yaxt="n",type="n",xaxt="n")
mtext("Temperature (dorm. season)",side=1,line=1,cex=1.2)
...
```{r}
geo_sr_past <- merge(x = sexratio_past,y =clim_past_values,by=c("pptdorm","tempdorm"))
geo_sr_current <- merge(x = sexratio_current,y =clim_current_values,by=c("pptdorm","tempdorm")) 
geo_sr_cmc_85 <- merge(x = sexratio_cmc85,y =climate_cmc_85_values,by=c("pptdorm","tempdorm"))
geo_sr_cmc_45 <- merge(x = sexratio_cmc45,y =climate_cmc_45_values,by=c("pptdorm","tempdorm")) 
geo_sr_miroc_85 <- merge(x = sexratio_miroc85,y =climate_miroc85_values,by=c("pptdorm","tempdorm"))
geo_sr_miroc_45 <- merge(x = sexratio_miroc45,y =climate_miroc45_values,by=c("pptdorm","tempdorm")) 
geo_sr_ces_85 <- merge(x = sexratio_ces85,y =climate_ces_85_values,by=c("pptdorm","tempdorm"))
geo_sr_ces_45 <- merge(x = sexratio_ces45,y =climate_ces_45_values,by=c("pptdorm","tempdorm")) 
geo_sr_acc_85 <- merge(x =sexratio_acc85 ,y =climate_acc_85_values,by=c("pptdorm","tempdorm"))
geo_sr_acc_45 <- merge(x = sexratio_acc45,y =climate_acc_45_values,by=c("pptdorm","tempdorm")) 
...
(map_past_osr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-107,-92), ylim = c(25,41)) +
  geom_tile(data = geo_sr_past, aes(x = x, y = y, fill = OSR))+
  annotate(geom="text", x=-100, y=41, label="Past",
              color="grey",size = 3)+
  scale_fill_gradientn(
    name = "OSR",
...
(map_current_osr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = geo_sr_current, aes(x = x, y = y, fill = OSR))+
  # geom_point(data=poar_occ_1990_2019,aes(lon, lat),alpha=1/5)+
  annotate(geom="text", x=-100, y=41, label="Current",
              color="grey",size = 3)+
  scale_fill_gradientn(
...
(map_cmc45_osr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = geo_sr_cmc_45, aes(x = x, y = y, fill = OSR))+
  # geom_point(data=poar_occ_1990_2019,aes(lon, lat),alpha=1/5)+
  annotate(geom="text", x=-100, y=41, label="RCP 4.5",
              color="grey",size = 3)+
  scale_fill_gradientn(
...
(map_cmc85_osr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = geo_sr_cmc_85, aes(x = x, y = y, fill = OSR))+
  # geom_point(data=poar_occ_1990_2019,aes(lon, lat),alpha=1/5)+
  annotate(geom="text", x=-100, y=41, label="RCP 8.5",
              color="grey",size = 3)+
  scale_fill_gradientn(
...
(map_past_sr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-107,-92), ylim = c(25,41)) +
  geom_tile(data = geo_sr_past, aes(x = x, y = y, fill = SR))+
  annotate(geom="text", x=-100, y=41, label="Past",
              color="grey",size = 3)+
  scale_fill_gradientn(
    name = "SR",
...
(map_current_sr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = geo_sr_current, aes(x = x, y = y, fill = SR))+
  # geom_point(data=poar_occ_1990_2019,aes(lon, lat),alpha=1/5)+
  annotate(geom="text", x=-100, y=41, label="Current",
              color="grey",size = 3)+
  scale_fill_gradientn(
...
(map_cmc45_sr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = geo_sr_cmc_45, aes(x = x, y = y, fill = SR))+
  # geom_point(data=poar_occ_1990_2019,aes(lon, lat),alpha=1/5)+
  annotate(geom="text", x=-100, y=41, label="RCP 4.5",
              color="grey",size = 3)+
  scale_fill_gradientn(
...
(map_cmc85_sr <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = geo_sr_cmc_85, aes(x = x, y = y, fill = SR))+
  # geom_point(data=poar_occ_1990_2019,aes(lon, lat),alpha=1/5)+
  annotate(geom="text", x=-100, y=41, label="RCP 8.5",
              color="grey",size = 3)+
  scale_fill_gradientn(
...
plot(garden_osr_poolyr$tempgrow*sd(garden_osr_poolyr_plot$tempgrow)+mean(garden_osr_poolyr_plot$tempgrow),garden_osr_poolyr$osr,ylim=c(0,1),cex.lab=1.2,cex.axis=1.2,
     xlab="Temerature (grow.season)",ylab="Sex ratio")
abline(h=0.5,col="gray",lty=2)
mtext("B",side = 3, adj = 0,cex=1.25)
for(p in 1:n_post_draws){
...
plot(garden_osr_poolyr$tempdorm*sd(garden_osr_poolyr_plot$tempdorm)+mean(garden_osr_poolyr_plot$tempdorm),garden_osr_poolyr$osr,ylim=c(0,1),cex.lab=1.2,cex.axis=1.2,
     xlab="Temperature (dorm.season)",ylab="Sex ratio")
mtext("D",side = 3, adj = 0,cex=1.25)
abline(h=0.5,col="gray",lty=2)
for(p in 1:n_post_draws){
