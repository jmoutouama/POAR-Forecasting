...
layout.matrix <- rbind(matrix(c(1,3,5,7), nrow = 1, ncol = 4, byrow = F),
                       matrix(c(2,4,6,8), nrow = 1, ncol = 4, byrow = F),
...
legend(525, 7.5, legend=c("Female dominant", "Two-sex"),
...
mtext("Time",side=2,line=3,cex=1.)
...
plot(all_tempgrow_seq*sd(poar_2015_2016$tempgrow)+mean(poar_2015_2016$tempgrow),lambda_tempgrow_all,ylim=c(0,2.5),
         xlab=" ",ylab=" ",yaxt="n",type="n",xaxt="n");box()
...
text(29, 2.1, "Past",cex=1.1)
text(30, 1.6, "Present",cex=1.1)
text(32, 1.1, "RCP 4.5",cex=1.1)
text(28, 0.6, "RCP 8.5",cex=1.1)
