...
```{r,eval=FALSE}
Location<-readRDS("/Users/jm200/Downloads/poar_ms_quantities.rds")
...
#print figure
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_past_present_future.pdf",height = 8,width = 8,useDingbats = F)
layout(mat = layout.matrix,
       heights = rep(c(2, 0.5),4), # Heights of the two rows
       widths = c(2, 2, 2))
# layout.show(8)

par(oma=c(5,2,1.5,0.5))
par(mar=c(0,4,1,0))
plot(all_pptgrow_seq*sd(poar_2015_2016$pptgrow)+mean(poar_2015_2016$pptgrow),lambda_pptgrow_all,ylim=c(0,8),
...
lines (all_pptgrow_seq*sd(poar_2015_2016$pptgrow)+mean(poar_2015_2016$pptgrow),lambda_pptgrow_all,col="#E69F00", lwd=4)
lines(all_pptgrow_seq*sd(poar_2015_2016$pptgrow)+mean(poar_2015_2016$pptgrow),lambda_pptgrow_all_2sex, col = "#999999",lwd=4) 
legend(510, 7.5, legend=c("Female dominant", "Two-sex"),
       col=c("#E69F00", "#999999"), lty=1:1, cex=1.5,bty = "n",lwd=4,seg.len =0.5:0.5)
...
mtext("Time",side=2,line=3,cex=1.2)
mtext("Precipitation (grow. season)",side=1,line=3,cex=1.2)
segments(x0 = rect_pptgrow[1,1],y0 = 2, x1 = rect_pptgrow[1,2],y1 = 2, col= colors[1],lwd = 5) 
segments(x0 = rect_pptgrow[2,1],y0 = 1.5, x1 = rect_pptgrow[2,2],y1 =1.5, col = colors[2],lwd = 5) 
segments(x0 = rect_pptgrow[3,1],y0 = 1, x1 = rect_pptgrow[3,2],y1 =1, col = colors[3],lwd = 5) 
segments(x0 = rect_pptgrow[4,1],y0 = 0.5, x1 = rect_pptgrow[4,2],y1 = 0.5, col = colors[4],lwd = 5) 

par(mar=c(0,4,1,0))
plot(all_tempgrow_seq*sd(poar_2015_2016$tempgrow)+mean(poar_2015_2016$tempgrow),lambda_tempgrow_all,ylim=c(0,5),
         xlab="Precipitation (grow. season) ",ylab=" ",xaxt="n",type="n");box()
mtext( "B",side = 3, adj = 0,cex=1.25)
# title(LETTERS[2],adj=0,cex.main=1.75)
abline(h = 1,lty=2,col="black")
lines(all_tempgrow_seq*sd(poar_2015_2016$tempgrow)+mean(poar_2015_2016$tempgrow),lambda_tempgrow_all,col="#E69F00", lwd=4)
lines(all_tempgrow_seq*sd(poar_2015_2016$tempgrow)+mean(poar_2015_2016$tempgrow),lambda_tempgrow_all_2sex, col = "#999999",lwd=4)   
...
segments(x0 = rect_tempgrow[1,1],y0 = 2, x1 = rect_tempgrow[1,2],y1 = 2, col= colors[1],lwd = 5) 
segments(x0 = rect_tempgrow[2,1],y0 = 1.5, x1 = rect_tempgrow[2,2],y1 =1.5, col = colors[2],lwd = 5) 
segments(x0 = rect_tempgrow[3,1],y0 = 1, x1 = rect_tempgrow[3,2],y1 =1, col = colors[3],lwd = 5) 
segments(x0 = rect_tempgrow[4,1],y0 = 0.5, x1 = rect_tempgrow[4,2],y1 = 0.5, col = colors[4],lwd = 5) 
...
mtext(expression(paste("Population growth rate, ", lambda)),side=2,line=3,cex=1.2)
abline(h = 1,lty=2,col="black")
lines(all_pptdorm_seq*sd(poar_2015_2016$pptdorm)+mean(poar_2015_2016$pptdorm),lambda_pptdorm_all,col="#E69F00", lwd=4)
lines(all_pptdorm_seq*sd(poar_2015_2016$pptdorm)+mean(poar_2015_2016$pptdorm),lambda_pptdorm_all_2sex, col = "#999999",lwd=4)
...
mtext("Time",side=2,line=3,cex=1.2)
segments(x0 = rect_pptdorm[1,1], x1 = rect_pptdorm[1,2], y0 = 2, y1 = 2, col = colors[1],lwd = 5)
segments(x0 = rect_pptdorm[2,1], x1 = rect_pptdorm[2,2], y0 = 1.5, y1 = 1.5, col = colors[2],lwd = 5) 
segments(x0 = rect_pptdorm[3,1], x1 = rect_pptdorm[3,2], y0 = 1, y1 = 1, col = colors[3],lwd = 5)
segments(x0 = rect_pptdorm[4,1], x1 = rect_pptdorm[4,2], y0 = 0.5, y1 = 0.5, col = colors[4],lwd = 5)
...
abline(h = 1,lty=2,col="black")
lines(all_tempdorm_seq*sd(poar_2015_2016$tempdorm)+mean(poar_2015_2016$tempdorm),lambda_tempdorm_all,col="#E69F00", lwd=4)
lines(all_tempdorm_seq*sd(poar_2015_2016$tempdorm)+mean(poar_2015_2016$tempdorm),lambda_tempdorm_all_2sex, col = "#999999",lwd=4)
...
segments(x0 = rect_tempdorm[1,1], x1 = rect_tempdorm[1,2], y0 = 2, y1 = 2, col = colors[1],lwd = 5)
segments(x0 = rect_tempdorm[2,1], x1 = rect_tempdorm[2,2], y0 = 1.5, y1 = 1.5, col = colors[2],lwd = 5) 
segments(x0 = rect_tempdorm[3,1], x1 = rect_tempdorm[3,2], y0 = 1, y1 = 1, col = colors[3],lwd = 5)
segments(x0 = rect_tempdorm[4,1], x1 = rect_tempdorm[4,2], y0 = 0.5, y1 = 0.5, col = colors[4],lwd = 5)
...
figcombo1<-ggplot() +
  ...
  geom_hline(yintercept = 1, lty=2,color = "black")+
  geom_segment(aes(x = rect_pptgrow[1,1], xend = rect_pptgrow[1,2], y = 2, yend = 2, color = "Past"), 
                 data = rect_pptgrow, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_pptgrow[2,1], xend = rect_pptgrow[2,2], y = 1.90, yend = 1.90, color = "Present"), 
                 data = rect_pptgrow, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_pptgrow[3,1], xend = rect_pptgrow[3,2], y = 1.80, yend = 1.80, color = "RCP4.5"), 
                 data = rect_pptgrow, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_pptgrow[4,1], xend = rect_pptgrow[4,2], y = 1.70, yend = 1.70, color = "RCP8.5"), 
                 data = rect_pptgrow, inherit.aes = FALSE) +
  xlab(" Precipitation (grow. season)") +
  ylab(expression(paste("Population growth rate, ", lambda))) +
  labs(color = "") +
...
figcombo2<-ggplot() +
  ...
  geom_hline(yintercept = 1, lty=2,color = "black")+
  geom_segment(aes(x = rect_tempgrow[1,1], xend = rect_tempgrow[1,2], y = 2, yend = 2, color = "Past"), 
                 data = rect_tempgrow, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_tempgrow[2,1], xend = rect_tempgrow[2,2], y = 1.75, yend = 1.75, color = "Present"), 
                 data = rect_tempgrow, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_tempgrow[3,1], xend = rect_tempgrow[3,2], y = 1.5, yend = 1.5, color = "RCP4.5"), 
                 data = rect_pptgrow, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_tempgrow[4,1], xend = rect_tempgrow[4,2], y = 1.25, yend = 1.25, color = "RCP8.5"), 
                 data = rect_tempgrow, inherit.aes = FALSE) +
  xlab(" Temperature (grow. season)") +
  ylab(expression(paste("Population growth rate, ", lambda))) +
  scale_color_manual(values = colors)+
...
figcombo3<-ggplot() +
  ...
  geom_hline(yintercept = 1, lty=2,color = "black")+
  xlab(" Precipitation (dorm. season)") +
  geom_segment(aes(x = rect_pptdorm[1,1], xend = rect_pptdorm[1,2], y = 2, yend = 2, color = "Past"), 
                 data = rect_pptdorm, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_pptdorm[2,1], xend = rect_pptdorm[2,2], y = 1.75, yend = 1.75, color = "Present"), 
                 data = rect_pptdorm, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_pptdorm[3,1], xend = rect_pptdorm[3,2], y = 1.5, yend = 1.5, color = "RCP4.5"), 
                 data = rect_pptdorm, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_pptdorm[4,1], xend = rect_pptdorm[4,2], y = 1.25, yend = 1.25, color = "RCP8.5"), 
                 data = rect_pptdorm, inherit.aes = FALSE) +
  ylab(expression(paste("Population growth rate, ", lambda))) +
  scale_color_manual(values = colors)+
  ggtitle("")+
...
figcombo4<-ggplot() +
  ...
  geom_hline(yintercept = 1, lty=2,color = "black")+
  geom_segment(aes(x = rect_tempdorm[1,1], xend = rect_tempdorm[1,2], y = 2, yend = 2, color = "Past"), 
                 data = rect_tempdorm, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_tempdorm[2,1], xend = rect_tempdorm[2,2], y = 1.75, yend = 1.75, color = "Present"), 
                 data = rect_tempdorm, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_tempdorm[3,1], xend = rect_tempdorm[3,2], y = 1.5, yend = 1.5, color = "RCP4.5"), 
                 data = rect_tempdorm, inherit.aes = FALSE) +
  geom_segment(aes(x = rect_tempdorm[4,1], xend = rect_tempdorm[4,2], y = 1.25, yend = 1.25, color = "RCP8.5"), 
                 data = rect_tempdorm, inherit.aes = FALSE) +
  xlab(" Temperature (dorm. season)") +
  ylab(expression(paste("Population growth rate, ", lambda))) +
  scale_color_manual(values = colors)+
...
```{r}
figosr1<-ggplot() +
  geom_line(aes(all_pptgrow_seq*sd(poar_2015_2016$pptgrow)+mean(poar_2015_2016$pptgrow),OSR_pptgrow_all), col = "#000000",size=1) +
...
figosr2<-ggplot() +
  geom_line(aes(all_tempgrow_seq*sd(poar_2015_2016$tempgrow)+mean(poar_2015_2016$tempgrow),OSR_tempgrow_all), col = "#000000",size=1)+
  geom_rect(aes(xmin = xmin, xmax = xmax, ymin = -Inf, ymax = Inf, fill = Time), 
...
figors3<-ggplot() +
  geom_line(aes(all_pptdorm_seq*sd(poar_2015_2016$pptdorm)+mean(poar_2015_2016$pptdorm),OSR_pptdorm_all), col = "#000000",size=1)+
  xlab(" Precipitation (dorm. season)") +
  geom_rect(aes(xmin = xmin, xmax = xmax, ymin = -Inf, ymax = Inf, fill = Time), 
...
figcombo4<-ggplot() +
  geom_line(aes(all_tempdorm_seq*sd(poar_2015_2016$tempdorm)+mean(poar_2015_2016$tempdorm),OSR_tempdorm_all), col = "#000000",size=1) +
  geom_rect(aes(xmin = xmin, xmax = xmax, ymin = -Inf, ymax = Inf, fill = Time), 
...
```{r}
Locationinfo<-read_rds("/Users/jm200/Downloads/poar_ms_quantities.rds")
...
source<-sourceinfo[,2:3]
coordinates(survey) <- ~ Longitude + Latitude
CRS1 <- CRS("+init=epsg:4326") # WGS 84
crs(survey) <- CRS1
...
plot(garden,add=T,pch = 21,col="black",cex =1,bg="black")
plot(source,add=T,pch = 21,col="red",bg="red",cex =0.75)
legend(-106.5, 28.5, 
       legend=c("Natural populations ", "Common garden sites","Source populations"),
       pch = c(23,21,21),
       pt.cex=c(1.5,1,0.75),
...
plot(source,add=T,pch = 21,col="red",bg="red",cex =0.75)
# legend(-106.5, 28.5, 
#        legend=c("Natural population survey", "Common garden site","Source population"),
#        pch = c(23,21,21),
#        pt.cex=c(1.5,1,0.75),
#        col = c("black","black","red"),
#        pt.bg=c("grey","black","red"),
...
plot(source,add=T,pch = 21,col="red",bg="red",cex =0.75)
# legend(-106.5, 28.5, 
#        legend=c("Natural population ", "Common garden site","Source population"),
#        pch = c(23,21,21),
#        pt.cex=c(1.5,1,0.75),
#        col = c("black","black","red"),
#        pt.bg=c("grey","black","red"),
...
# write_csv(climate_miroc85_values,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Climatic data/climate_miroc85_values.csv")
```
...
# write_csv(clim_current_values,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Climatic data/clim_current_values.csv")
```
...
# write_csv(climate_miroc45_values,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Climatic data/clim_miroc_45_values.csv")
```
...
# write_csv(clim_past_values,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Climatic data/clim_past_values.csv")
```
...
# write_csv(climate_cmc_85_values,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Climatic data/climate_cmc_85_values.csv")
```
...
# write_csv(climate_cmc_45_values,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Climatic data/climate_cmc_45_values.csv")
```
...
```{r}
Fig_geoPrlambdamiroc<-ggarrange(lambda_map_Prpast, lambda_map_Prcurrent, lambda_map_Prmiroc45, lambda_map_Prmiroc85,lambda_map_Prpast_fd,lambda_map_Prcurrent_fd,lambda_map_miroc45_fd,lambda_map_miroc85_fd,common.legend = TRUE,ncol = 4, nrow = 2)
ggsave("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/Updated/Fig_geoPrlambda_miroc.pdf", Fig_geoPrlambdamiroc, width = 10, height = 8)
```
...
ggsave("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/Updated/Fig_geoPrlambdacmc.pdf", Fig_geoPrlambdacmc_all, width = 10, height = 8)
```
...
Fig_geoPrlambdaacc<-ggarrange(lambda_map_Prpast, lambda_map_Prcurrent, lambda_map_Pracc45, lambda_map_Pracc85,lambda_map_Prpast_fd, lambda_map_Prcurrent_fd,lambda_map_acc45_fd,lambda_map_acc85_fd,ncol=4,nrow=2,
                                        common.legend = TRUE)
ggsave("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/Updated/Fig_geoPrlambdaacc_.pdf", Fig_geoPrlambdaacc_all, width = 10, height = 8)
```
...
ggsave("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/Updated/Fig_geoPrlambda_ces.pdf", Fig_geoPrlambdaces,  width = 10, height = 8)
```
...
```{r}
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/niche_dormant_growing.pdf",width=8,height=7,useDingbats = F)
par(mar=c(5,5,1.5,0.5),mfrow=c(2,2))
fields::image.plot(all_pptdorm_seq,all_tempdorm_seq,mtrx_dorm,col=topo.colors(100),xlab="Precipitation (dorm. season)",ylab="Temperature (dorm. season)",main="") 
...
fields::image.plot(all_pptgrow_seq,all_tempgrow_seq,mtrx_grow,col=topo.colors(100),xlab="Precipitation (grow. season)",ylab="Temperature (grow. season)",main="") 
...
fields::image.plot(all_pptdorm_seq,all_tempdorm_seq,mtrx_dorm_fd,col=topo.colors(100),xlab="Precipitation (dorm. season)",ylab="Temperature (dorm. season)",main="") 
...
text(x=x_miroc45_d,y=y_miroc45_d,"*",col="black",cex=2)
text(x=x_miroc85_d,y=y_miroc85_d,".",col="black",cex=4.5)
fields::image.plot(all_pptgrow_seq,all_tempgrow_seq,mtrx_grow_fd,col=topo.colors(100),xlab="Precipitation (grow. season)",ylab="Temperature (grow. season)",main="") 
...
```{r}
sexratio_dormant<-read_csv(url("https://www.dropbox.com/scl/fi/dnevudg4yrhp7373lfhgq/OSR_dorm.csv?rlkey=4715a7cvjoank1jmx6gk7na67&dl=1"))
...
```{r}
# read in results of the above loop
sexratio_growing <- read_csv(url("https://www.dropbox.com/scl/fi/3xsgda5nn4lxu3fcbn284/OSR_grow.csv?rlkey=1svxkjjvsiqhvfm82wvwcno78&dl=1"))
...
```{r}
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/OSR_3D.pdf",width=6,height=8,useDingbats = F)
...
par(mar=c(5,5,1,1),mfrow=c(2,1))
fields::image.plot(all_pptdorm_seq,all_tempdorm_seq,OSR_mtrx_dorm,col=topo.colors(100),xlab="Precipitation dormant",ylab="Temperature dormant",main="") 
...
par(mar=c(5,5,1,1),mfrow=c(2,1))
fields::image.plot(all_pptdorm_seq,all_tempdorm_seq,SR_mtrx_dorm,col=topo.colors(100),xlab="Precipitation dormant",ylab="Temperature dormant",main="") 
...
SR_conditions_1901_1930 <- terra::extract(clim_1990_2019,POAR_coordinate)
SR_clim_past<-data.frame(SR_conditions_1901_1930)
SR_conditions_1990_2019 <- terra::extract(clim_1990_2019,POAR_coordinate)
SR_clim_current<-data.frame(SR_conditions_1901_1930)
SR_conditions_cmc_45 <- terra::extract(clim_cmcc_45,POAR_coordinate)
SR_clim_cmc_45<-data.frame(SR_conditions_cmc_45)
SR_conditions_cmc_85 <- terra::extract(clim_cmcc_85,POAR_coordinate)
SR_clim_cmc_85<-data.frame(SR_conditions_cmc_85)
data_SR<-cbind(POAR,SR_clim_current)
dim(data_SR)
data_SR_time<-rbind(SR_clim_past,SR_clim_current,SR_clim_cmc_45,SR_conditions_cmc_85)
```
...
survey_dat <- list(y = data_SR$Total.Female.Infl.,
                   n_trials = data_SR$Total.Male.Infl.+POAR$Total.Female.Infl.,
                   pptdorm = as.vector(scale(data_SR$pptdorm)) ,
                   tempdorm =as.vector(scale(data_SR$tempdorm)),
                   pptgrow =as.vector(scale(data_SR$pptgrow)),
                   tempgrow = as.vector(scale(data_SR$tempgrow)),
                   N = nrow(data_SR))
...
fit_survey_tempdorm <- stan(
  file = '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Analysis/stan/poar_survey_temporm.stan',
  data = survey_dat,
  warmup = sim_pars$warmup,
  iter = sim_pars$iter,
  thin = sim_pars$thin,
...
fit_survey_tempgrow <- stan(
  file = '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Analysis/stan/poar_survey_tempgrow.stan',
  data = survey_dat,
  warmup = sim_pars$warmup,
  iter = sim_pars$iter,
  thin = sim_pars$thin,
...
```{r}
traceplot(fit_survey_tempdorm, pars = quote_bare(b0,b_tempdorm))+theme_bw()
traceplot(fit_survey_tempgrow, pars = quote_bare(b0,b_tempgrow))+theme_bw()
```

```{r}
## pull out coefficients
n_post_draws <- 300
coef_survey_tempdorm <- rstan::extract(fit_survey_tempdorm,par=c("b0","b_tempdorm"))
coef_survey_tempdorm_mean <- lapply(coef_survey_tempdorm,mean)
coef_survey_tempgrow <- rstan::extract(fit_survey_tempgrow,par=c("b0","b_tempgrow"))
coef_survey_tempgrow_mean <- lapply(coef_survey_tempgrow,mean)
sr_post_draws <- sample.int(length(coef_survey_tempdorm$b0), n_post_draws)
```

```{r}
# dummy variable for plotting
x_tempgrow <- seq(min(scale(data_SR_time$tempgrow)),max(scale(data_SR_time$tempgrow)),length = 100)
x_tempdorm <- seq(min(scale(data_SR_time$tempdorm)),max(scale(data_SR_time$tempdorm)),length = 100)
...
garden_osr <- poar.clim_seasonal %>% 
  dplyr::select( year, site, Sex,ztempgrow,ztempdorm,flowerN_t1) %>% 
  group_by(year, ztempgrow, ztempdorm,site, Sex) %>% 
...
garden_osr_poolyr <- poar %>% 
  dplyr::select(site, Sex, ztempgrow, ztempdorm,flowerN_t1) %>% 
  group_by(ztempgrow,ztempdorm, site, Sex) %>% 
  summarise(total_panicles = sum(flowerN_t1,na.rm=T)) %>% 
  spread(key=Sex,value=total_panicles) %>% 
  rename(fem_pan = `F`,
         mal_pan = `M`,
  ...
  mutate(tot_pan=fem_pan+mal_pan,
         osr = fem_pan/tot_pan)
ggplot(garden_osr)+
  geom_point(aes(x=tempgrow,y=osr,color=as.factor(year)))

##sex ratio by year
garden_sr <- poar %>% 
  dplyr::select( year, site, Sex, ztempgrow, ztempdorm,surv_t1) %>% 
  group_by(year, ztempgrow,ztempdorm, site, Sex) %>% 
...
garden_sr_poolyr <- poar %>%
  dplyr::select(site, Sex, ztempgrow,ztempdorm, surv_t1) %>% 
  group_by(ztempgrow,ztempdorm, site, Sex) %>% 
  summarise(total_plants = sum(surv_t1,na.rm=T)) %>% 
  spread(key=Sex,value=total_plants) %>% 
  rename(fem = `F`,
  ...
  mutate(total=fem+mal,
         sr = fem/total)
ggplot(garden_sr)+
  geom_point(aes(x=tempgrow,y=sr,color=as.factor(year)))
...
```{r}
## pull out coefficients
coef_garden_osr_tempgrow <- rstan::extract(fit_garden_osr_tempgrow,par=c("b0","b_tempgrow"))
coef_garden_osr_tempgrow_mean <- lapply(coef_garden_osr_tempgrow,mean)
coef_garden_osr_tempdorm <- rstan::extract(fit_garden_osr_tempdorm,par=c("b0","b_tempdorm"))
coef_garden_osr_tempdorm_mean <- lapply(coef_garden_osr_tempdorm,mean)
```
...
```{r}
## pull out coefficients
coef_garden_sr_tempgrow <- rstan::extract(fit_garden_sr_tempgrow,par=c("b0","b_tempgrow"))
coef_garden_sr_tempgrow_mean <- lapply(coef_garden_sr_tempgrow,mean)
coef_garden_sr_tempdorm <- rstan::extract(fit_garden_sr_tempdorm,par=c("b0","b_tempdorm"))
coef_garden_sr_tempdorm_mean <- lapply(coef_garden_sr_tempdorm,mean)
...
#print figure
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/nat_pops_gardens_SR.pdf",useDingbats = F,height=4,width=12)
par(mfrow=c(1,3),mar=c(5,5,2,1))
## natural populations
plot(survey_dat$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),
     survey_dat$y/survey_dat$n_trials,pch=1,type="n",xlim=c(min(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow)),max(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow))),
     ylim=c(0,1),
     cex=log(survey_dat$n_trials),#cex=4*(survey_dat$n_trials/max(survey_dat$n_trials))+1,#
     xlab="Temerature (grow.season)",ylab="Proportion female panicles",cex.lab=1.8,cex.axis=1.4,
     col=alpha("#E6AB02",1))
...
for(p in 1:n_post_draws){
  lines(x_tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),
        invlogit(coef_survey_tempgrow$b0[sr_post_draws[p]] + coef_survey_tempgrow$b_tempgrow[sr_post_draws[p]] * x_tempgrow),
        col=alpha("#E6AB02",0.1))
}
points(survey_dat$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),
       survey_dat$y/survey_dat$n_trials,col=alpha("#E6AB02",1),cex=log(survey_dat$n_trials),lwd=2,bg="#E6AB02")

## common gardens
plot(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),garden_osr_poolyr$osr,ylim=c(0,1),cex.lab=1.8,cex.axis=1.4,
     type="n",xlim=c(min(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow)),max(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow))),
     xlab="Temerature (grow.season)",ylab="Proportion female panicles")#cex=4*(garden_osr_poolyr$tot_pan/max(garden_osr_poolyr$tot_pan))+1.5)#
abline(h=0.5,col="gray",lty=2)
...
for(p in 1:n_post_draws){
  lines(x_tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),
        invlogit(coef_garden_osr_tempgrow$b0[sr_post_draws[p]] + coef_garden_osr_tempgrow$b_tempgrow[sr_post_draws[p]] * x_tempgrow),
        col=alpha("#E6AB02",0.1))
}
points(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),cex=log(garden_osr_poolyr$tot_pan),
       garden_osr_poolyr$osr,lwd=2,col=alpha("#E6AB02",1),bg="#E6AB02")

plot(garden_sr_poolyr$ztempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),garden_sr_poolyr$sr,ylim=c(0,1),cex.lab=1.8,cex.axis=1.4,
     xlim=c(min(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow)),max(garden_osr_poolyr$tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow))),
     xlab="Temerature (grow.season)",ylab="Proportion female plants",cex=log(garden_sr_poolyr$total))#cex=4*(garden_sr_poolyr$total/max(garden_sr_poolyr$total))+1.5)#
abline(h=0.5,col="gray",lty=2)
...
for(p in 1:n_post_draws){
  lines(x_tempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),
        invlogit(coef_garden_sr_tempgrow$b0[sr_post_draws[p]] + coef_garden_sr_tempgrow$b_tempgrow[sr_post_draws[p]] * x_tempgrow),
        col=alpha("#E6AB02",0.1))
}
points(garden_sr_poolyr$ztempgrow*sd(data_SR$tempgrow) + mean(data_SR$tempgrow),garden_sr_poolyr$sr,
       lwd=2,col=alpha("#E6AB02",1),cex=log(garden_sr_poolyr$total),bg="#E6AB02")
dev.off()

```

```{r}
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/nat_pops_gardens_SR_tempdorm.pdf",useDingbats = F,height=4,width=12)
par(mfrow=c(1,3),mar=c(5,5,2,1))
## natural populations
plot(survey_dat$tempg*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),
     survey_dat$y/survey_dat$n_trials,pch=1,type="n",xlim=c(min(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm)),max(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm))),
     ylim=c(0,1),
     cex=log(survey_dat$n_trials),#cex=4*(survey_dat$n_trials/max(survey_dat$n_trials))+1,#
     xlab="Temerature (dorm.season)",ylab="Proportion female panicles",cex.lab=1.8,cex.axis=1.4,
     col=alpha("#E6AB02",1))
title("A) Natural population OSR",adj=0,font=4,cex.main=1.6)
abline(h=0.5,col="gray",lty=2)
#lines(x_long + mean(POAR$Longitude),
#      invlogit(mean(coef_surv$b0) + mean(coef_surv$b_long) * x_long),lwd=3,col="black")
for(p in 1:n_post_draws){
  lines(x_tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),
        invlogit(coef_survey_tempdorm$b0[sr_post_draws[p]] + coef_survey_tempdorm$b_tempdorm[sr_post_draws[p]] * x_tempdorm),
        col=alpha("#E6AB02",0.1))
}
points(survey_dat$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),
       survey_dat$y/survey_dat$n_trials,col=alpha("#E6AB02",1),cex=log(survey_dat$n_trials),lwd=2,bg="#E6AB02")

## common gardens
plot(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),garden_osr_poolyr$osr,ylim=c(0,1),cex.lab=1.8,cex.axis=1.4,
     type="n",xlim=c(min(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm)),max(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm))),
     xlab="Temerature (dorm.season)",ylab="Proportion female panicles")#cex=4*(garden_osr_poolyr$tot_pan/max(garden_osr_poolyr$tot_pan))+1.5)#
abline(h=0.5,col="gray",lty=2)
title("B) Common garden OSR",adj=0,font=4,cex.main=1.6)
#lines(long_seq + mean(latlong$Longitude),invlogit(coef(osr_glm_poolyr)[1] + coef(osr_glm_poolyr)[2]*long_seq),lwd=3)
#lines(long_seq + mean(latlong$Longitude),invlogit(coef_garden_osr_mean$b0 + coef_garden_osr_mean$b_long*long_seq),lwd=3)
for(p in 1:n_post_draws){
  lines(x_tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),
        invlogit(coef_garden_osr_tempdorm$b0[sr_post_draws[p]] + coef_garden_osr_tempdorm$b_tempdorm[sr_post_draws[p]] * x_tempdorm),
        col=alpha("#E6AB02",0.1))
}
points(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),cex=log(garden_osr_poolyr$tot_pan),
       garden_osr_poolyr$osr,lwd=2,col=alpha("#E6AB02",1),bg="#E6AB02")

plot(garden_sr_poolyr$ztempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),garden_sr_poolyr$sr,ylim=c(0,1),cex.lab=1.8,cex.axis=1.4,
     xlim=c(min(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm)),max(garden_osr_poolyr$tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm))),
     xlab="Temerature (dorm.season)",ylab="Proportion female plants",cex=log(garden_sr_poolyr$total))#cex=4*(garden_sr_poolyr$total/max(garden_sr_poolyr$total))+1.5)#
abline(h=0.5,col="gray",lty=2)
title("C) Common garden SR",adj=0,font=4,cex.main=1.6)
#lines(long_seq + mean(latlong$Longitude),invlogit(coef(sr_glm_poolyr)[1] + coef(sr_glm_poolyr)[2]*long_seq),lwd=3)
#lines(long_seq + mean(latlong$Longitude),invlogit(coef_garden_sr_mean$b0 + coef_garden_sr_mean$b_long*long_seq),lwd=3)
for(p in 1:n_post_draws){
  lines(x_tempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),
        invlogit(coef_garden_sr_tempdorm$b0[sr_post_draws[p]] + coef_garden_sr_tempdorm$b_tempdorm[sr_post_draws[p]] * x_tempdorm),
        col=alpha("#E6AB02",0.1))
}
points(garden_sr_poolyr$ztempdorm*sd(data_SR$tempdorm) + mean(data_SR$tempdorm),garden_sr_poolyr$sr,
       lwd=2,col=alpha("#E6AB02",1),cex=log(garden_sr_poolyr$total),bg="#E6AB02")
dev.off()
