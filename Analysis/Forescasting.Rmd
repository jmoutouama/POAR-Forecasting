...
for(l in 1:nrow(pivot_lambdaacc_45)){
  prob_lambdaacc_45_post[l]<-mean(pivot_lambdaacc_45[l,]>1,na.rm=T)
}
...
ggsave("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/Fig_geoPrlambdaprojectionacc.pdf", Fig_geoPrlambdacmcprojection, width = 5, height = 7)
```
...
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/LTRE_Temperature.pdf",width=7,height=6,useDingbats = F)
par(oma=c(5,2,1.5,0.5))
...
plot(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow),colSums(LTRE_TEMPGROW_out[1:8,]),type="l",lwd=3,col="grey20",lty=1,
     xlab="Temperature growing",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"tempgrow")),cex.lab=1.2)
...
plot(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow),colSums(LTRE_TEMPGROW_out[9:16,]),type="l",lwd=3,col="grey20",
     xlab="Temperature growing",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"tempgrow")),cex.lab=1.2)
sex.symbols(9, -1.5, sex = 1, cex = 1.5, lwd = 2, col = "black")  
abline(h=0,col="black")
...
plot(all_tempdorm_seq*sd(poar_2015_2016$tempdorm) + mean(poar_2015_2016$tempdorm),colSums(LTRE_TEMPDORM_out[1:8,]),type="l",lwd=3,col="grey20",lty=1,
     xlab="Temperature dormant",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"tempdorm")),cex.lab=1.2)
abline(h=0,col="black")
for(i in seq(1,8,by=2)){
...
plot(all_tempdorm_seq*sd(poar_2015_2016$tempdorm) + mean(poar_2015_2016$tempdorm),colSums(LTRE_TEMPDORM_out[9:16,]),type="l",lwd=3,col="grey20",
     xlab="Temperature dormant",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"tempdorm")),cex.lab=1.2,ylim=c(-10,5))
abline(h=0,col="black")
for(i in seq(9,16,by=2)){
...
sex.symbols(25, -7.5, sex = 1, cex = 1.5, lwd = 2, col = "black") 
mtext( "D",side = 3, adj = 0,cex=1.25)
dev.off()
```
...
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/LTRE_Precipitation.pdf",width=7,height=6,useDingbats = F)
par(oma=c(5,2,1.5,0.5))
# par(mar=c(5,4,1,0),mfrow=c(2,2))
par(mar=c(5,5,1,1),mfrow=c(2,2))
plot(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow),colSums(LTRE_PPTGROW_out[1:8,]),type="l",lwd=3,ylim=c(-7,2),col="grey20",lty=1,
     xlab="Precipitation growing",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"pptgrow")),cex.lab=1.2)
sex.symbols(700, -6, sex = 2, cex = 1.5, lwd = 2, col = "black")  
abline(h=0,col="black")
for(i in seq(1,8,by=2)){
...
mtext( "A",side = 3, adj = 0,cex=1.25)
plot(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow),colSums(LTRE_PPTGROW_out[9:16,]),type="l",lwd=3,ylim=c(-0.5,0.5),col="grey20",
     xlab="Precipitation growing",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"pptgrow")),cex.lab=1.2)
sex.symbols(700, -0.4, sex = 1, cex = 1.5, lwd = 2, col = "black")  
abline(h=0,col="black")
for(i in seq(9,16,by=2)){
...
plot(all_pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm),colSums(LTRE_PPTDORM_out[1:8,]),type="l",lwd=3,ylim=c(-7,4),col="grey20",lty=1,
     xlab="Precipitation dormant",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"pptdormant")),cex.lab=1.2)
sex.symbols(400, -5, sex = 2, cex = 1.5, lwd = 2, col = "black")  
abline(h=0,col="black")
for(i in seq(1,8,by=2)){
...
plot(all_pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm),colSums(LTRE_PPTGROW_out[9:16,]),type="l",lwd=3,col="grey20",
     xlab="Precipitation dormant",ylab=expression(paste(partialdiff,lambda," / ",partialdiff,"pptdorm")),cex.lab=1.2)
sex.symbols(400, -0.4, sex = 1, cex = 1.5, lwd = 2, col = "black")  
abline(h=0,col="black")
for(i in seq(9,16,by=2)){
