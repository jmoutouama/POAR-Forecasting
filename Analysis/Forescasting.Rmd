...
```{r}
fit_allsites_season <- readRDS("C:/Users/tm9/Dropbox/Miller Lab -- Moutouama/Forecasting Models output/fit_allsites_seasons_02_06_24.rds")
...
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_observed.pdf",width=5,height=5,useDingbats = F)
...
pptgrow_seq <- seq(min(poar_2015_2016$zpptgrow),max(poar_2015_2016$zpptgrow),length.out=20)
max_yrs <- 30
lambda_pptgrow_post  <- SR_pptgrow_post <- OSR_pptgrow_post <-lambda_pptgrow_post_rfx  <- SR_pptgrow_post_rfx <- OSR_pptgrow_post_rfx <- matrix(NA,nrow=n_post_draws,ncol=length(pptgrow_seq))
...
write_rds(lambda_pptgrow_post_list,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Posterior/lambda_pptgrow_post_list_feb24.rds")
```

```{r}
# read in results of the above loop
lambda_pptgrow_post_list <- readRDS(url("https://www.dropbox.com/scl/fi/zdrdq4yldpson8e0xpb58/lambda_pptgrow_post_list.rds?rlkey=6gfd0og453pwt1gvjcla0aj7s&dl=1"))
```
...
lambda_pptgrow_mean <- lambda_pptgrow_mean <- c()
for(l in 1:length(pptgrow_seq)){
...
plot(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow),lambda_pptgrow_mean_2sex,type="l",
...
polygon(x=c(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow),rev(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow))),
        ...
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow),rev(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow))),
        y=c(lambda_pptgrow_rfx_q50[1,],rev(lambda_pptgrow_rfx_q50[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow) ,rev(pptgrow_seq*sd(poar_2015_2016$pptgrow) + mean(poar_2015_2016$pptgrow))),
...
tempgrow_seq <- seq(min(poar_2015_2016$ztempgrow),max(poar_2015_2016$ztempgrow),length.out=20)
max_yrs <- 30
lambda_tempgrow_post <- Fdom_lambda_tempgrow <- SR_tempgrow_post <- OSR_tempgrow_post <-lambda_tempgrow_post_rfx <- Fdom_lambda_tempgrow_rfx <- SR_tempgrow_post_rfx <- OSR_tempgrow_post_rfx <- matrix(NA,nrow=n_post_draws,ncol=length(tempgrow_seq))
...
for(p in 1:n_post_draws){
 ...
 for(l in 1:length(tempgrow_seq)){
  ...
  lambda_run <- lambdaSim_delay(F_params=F_params,M_params=M_params,zpptgrow=pptgrow_seq[l],ztempgrow=0,zpptdorm=0,ztempdorm=0,rfx=rfx_fun(),max.yrs=max_yrs)
   ...
   #Estimation+process error
   lambda_run_rfx <- lambdaSim_delay(F_params=F_params,M_params=M_params,zpptgrow=0,ztempgrow=tempgrow_seq[l],zpptdorm=0,ztempdorm=0,rfx=rfx,max.yrs=max_yrs)
...
## write output as a list
lambda_tempgrow_post_list <- list(lambda_tempgrow_post_rfx=lambda_tempgrow_post_rfx,SR_tempgrow_post_rfx=SR_tempgrow_post_rfx,OSR_tempgrow_post_rfx=OSR_tempgrow_post_rfx)
...
```{r,eval=FALSE}
## I am tryng the paralle computing here to save some time. 
n_post_draws <- 300
post_draws <- sample.int(length(surv_coef$b0_s), n_post_draws)
tempgrow_seq <- seq(min(poar_2015_2016$ztempgrow),max(poar_2015_2016$ztempgrow),length.out=20)
max_yrs <- 30
lambda_tempgrow_post_rfx <- Fdom_lambda_tempgrow_rfx <- SR_tempgrow_post_rfx <- OSR_tempgrow_post_rfx <- matrix(NA,nrow=n_post_draws,ncol=length(tempgrow_seq))

F_params <- M_params <- list()
foreach (p=1:n_post_draws,.combine='rbind') %:% 
...
```{r}
lambda_tempgrow_rfx_q95 <- lambda_tempgrow_rfx_q75 <- lambda_tempgrow_rfx_q50 <- lambda_tempgrow_rfx_q25 <- lambda_tempgrow_rfx_q5 <- matrix(NA,2,length(tempgrow_seq))
lambda_tempgrow_mean <- lambda_tempgrow_rfx_mean <- c()
for(l in 1:length(tempgrow_seq)){
  lambda_tempgrow_rfx_q95[,l] <- quantile(lambda_tempgrow_post_list$lambda_tempgrow_post_rfx[,l],probs=c(0.025,0.975),na.rm = T)
  lambda_tempgrow_rfx_q75[,l] <- quantile(lambda_tempgrow_post_list$lambda_tempgrow_post_rfx[,l],probs=c(0.125,0.875),na.rm = T)
  lambda_tempgrow_rfx_q50[,l] <- quantile(lambda_tempgrow_post_list$lambda_tempgrow_post_rfx[,l],probs=c(0.25,0.75),na.rm = T)
  lambda_tempgrow_rfx_q25[,l] <- quantile(lambda_tempgrow_post_list$lambda_tempgrow_post_rfx[,l],probs=c(0.375,0.625),na.rm = T)
  lambda_tempgrow_rfx_q5[,l] <- quantile(lambda_tempgrow_post_list$lambda_tempgrow_post_rfx[,l],probs=c(0.475,0.525),na.rm = T)
  lambda_tempgrow_rfx_mean[l] <- mean(lambda_tempgrow_post_list$lambda_tempgrow_post_rfx[,l],na.rm = T)
}
...
polygon_alpha <- 0.25
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_pptgrow_CI.pdf",useDingbats = F,height=5,width=5)
plot(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow),lambda_tempgrow_rfx_mean,type="l",
     xlab="Precipitation (grow. season)",ylab=expression(paste(lambda)),cex.lab=1.2,lwd=2)
polygon(x=c(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow),rev(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow) )),
        y=c(lambda_tempgrow_rfx_q95[1,],rev(lambda_tempgrow_rfx_q95[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow),rev(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow))),
        y=c(lambda_tempgrow_rfx_q75[1,],rev(lambda_tempgrow_rfx_q75[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow),rev(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow))),
        y=c(lambda_tempgrow_rfx_q50[1,],rev(lambda_tempgrow_rfx_q50[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow) ,rev(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow))),
        y=c(lambda_tempgrow_rfx_q25[1,],rev(lambda_tempgrow_rfx_q25[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow) ,rev(tempgrow_seq*sd(poar_2015_2016$tempgrow) + mean(poar_2015_2016$tempgrow) )),
        y=c(lambda_tempgrow_rfx_q5[1,],rev(lambda_tempgrow_rfx_q5[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
abline(h=1,lty=3)
...
pptdorm_seq <- seq(min(poar_2015_2016$zpptdorm),max(poar_2015_2016$zpptdorm),length.out=20)
max_yrs <- 30
lambda_pptdorm_post_rfx <- Fdom_lambda_pptdorm_rfx <- SR_pptdorm_post_rfx <- OSR_pptdorm_post_rfx <- matrix(NA,nrow=n_post_draws,ncol=length(pptdorm_seq))
...
for(p in 1:n_post_draws){
 ...
 for(l in 1:length(pptdorm_seq)){
   #Estimation+process error
   lambda_run_rfx <- lambdaSim_delay(F_params=F_params,M_params=M_params,zpptgrow=0,ztempgrow=0,zpptdorm=pptdorm_seq[l],ztempdorm=0,rfx=rfx,max.yrs=max_yrs)
   lambda_pptdorm_post_rfx[p,l] <- lambda_run_rfx$lambdatracker[max_yrs]
   SR_pptdorm_post_rfx[p,l] <- lambda_run_rfx$SRtracker[max_yrs]
   OSR_pptdorm_post_rfx[p,l] <- lambda_run_rfx$OSRtracker[max_yrs]
   print(c(p,l))
 }
}
## write output as a list
lambda_pptdorm_post_list <- list(lambda_pptdorm_post_rfx=lambda_pptdorm_post_rfx,SR_pptdorm_post_rfx=SR_pptdorm_post_rfx,OSR_pptdorm_post_rfx=OSR_pptdorm_post_rfx)
...
```{r}
## visualize results
lambda_pptdorm_rfx_q95 <- lambda_pptdorm_rfx_q75 <- lambda_pptdorm_rfx_q50 <- lambda_pptdorm_rfx_q25 <- lambda_pptdorm_rfx_q5 <- matrix(NA,2,length(pptdorm_seq))
lambda_pptdorm_mean <- lambda_pptdorm_rfx_mean <- c()
for(l in 1:length(pptdorm_seq)){
  lambda_pptdorm_rfx_q95[,l] <- quantile(lambda_pptdorm_post_list$lambda_pptdorm_post_rfx[,l],probs=c(0.025,0.975),na.rm = T)
  lambda_pptdorm_rfx_q75[,l] <- quantile(lambda_pptdorm_post_list$lambda_pptdorm_post_rfx[,l],probs=c(0.125,0.875),na.rm = T)
  lambda_pptdorm_rfx_q50[,l] <- quantile(lambda_pptdorm_post_list$lambda_pptdorm_post_rfx[,l],probs=c(0.25,0.75),na.rm = T)
  lambda_pptdorm_rfx_q25[,l] <- quantile(lambda_pptdorm_post_list$lambda_pptdorm_post_rfx[,l],probs=c(0.375,0.625),na.rm = T)
  lambda_pptdorm_rfx_q5[,l] <- quantile(lambda_pptdorm_post_list$lambda_pptdorm_post_rfx[,l],probs=c(0.475,0.525),na.rm = T)
  lambda_pptdorm_rfx_mean[l] <- mean(lambda_pptdorm_post_list$lambda_pptdorm_post_rfx[,l],na.rm = T)
}
...
polygon_alpha <- 0.25
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_pptgrow_CI.pdf",useDingbats = F,height=5,width=5)
plot(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm),lambda_pptdorm_rfx_mean,type="l",
     xlab="Precipitation (dorm. season)",ylab=expression(paste(lambda)),cex.lab=1.2,lwd=2)
polygon(x=c(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm),rev(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm) )),
        y=c(lambda_pptdorm_rfx_q95[1,],rev(lambda_pptdorm_rfx_q95[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm),rev(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm))),
        y=c(lambda_pptdorm_rfx_q75[1,],rev(lambda_pptdorm_rfx_q75[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm),rev(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm))),
        y=c(lambda_pptdorm_rfx_q50[1,],rev(lambda_pptdorm_rfx_q50[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm) ,rev(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm))),
        y=c(lambda_pptdorm_rfx_q25[1,],rev(lambda_pptdorm_rfx_q25[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
polygon(x=c(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm) ,rev(pptdorm_seq*sd(poar_2015_2016$pptdorm) + mean(poar_2015_2016$pptdorm) )),
        y=c(lambda_pptdorm_rfx_q5[1,],rev(lambda_pptdorm_rfx_q5[2,])),
        col=alpha(polygon_col,polygon_alpha),border=NA)
abline(h=1,lty=3)
...
tempdorm_seq <- seq(min(poar_2015_2016$ztempdorm),max(poar_2015_2016$ztempdorm),length.out=20)
max_yrs <- 30
lambda_tempdorm_post <- Fdom_lambda_tempdorm <- SR_tempdorm_post <- OSR_tempdorm_post<-lambda_tempdorm_post_rfx <- Fdom_lambda_tempdorm_rfx <- SR_tempdorm_post_rfx <- OSR_tempdorm_post_rfx <- matrix(NA,nrow=n_post_draws,ncol=length(tempdorm_seq))
...
for(p in 1:n_post_draws){
 ...
 for(l in 1:length(tempdorm_seq)){
   #Estimation error only
  lambda_run <- lambdaSim_delay(F_params=F_params,M_params=M_params,zpptgrow=0,ztempgrow=0,zpptdorm=0,ztempdorm=tempdorm_seq[l],rfx=rfx,max.yrs=max_yrs)
   lambda_tempdorm_post[p,l] <- lambda_run$lambdatracker[max_yrs]
   SR_tempdorm_post[p,l] <- lambda_run$SRtracker[max_yrs]
   OSR_tempdorm_post[p,l] <- lambda_run$OSRtracker[max_yrs]
   #Estimation+process error
   lambda_run_rfx <- lambdaSim_delay(F_params=F_params,M_params=M_params,zpptgrow=0,ztempgrow=0,zpptdorm=0,ztempdorm=tempdorm_seq[l],rfx=rfx,max.yrs=max_yrs)
   lambda_tempdorm_post_rfx[p,l] <- lambda_run_rfx$lambdatracker[max_yrs]
   SR_tempdorm_post_rfx[p,l] <- lambda_run_rfx$SRtracker[max_yrs]
   OSR_tempdorm_post_rfx[p,l] <- lambda_run_rfx$OSRtracker[max_yrs]
   print(c(p,l))
 }
}
## write output as a list
lambda_tempdorm_post_list <- list(lambda_tempdorm_post=lambda_tempdorm_post,SR_tempdorm_post=SR_tempdorm_post,OSR_tempdorm_post=OSR_tempdorm_post,lambda_tempdorm_post_rfx=lambda_tempdorm_post_rfx,SR_tempdorm_post_rfx=SR_tempdorm_post_rfx,OSR_tempdorm_post_rfx=OSR_tempdorm_post_rfx)


write_rds(lambda_tempdorm_post_list,"/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/Posterior/lambda_tempdorm_post_listfeb26.rds")
...
polygon_col <- "#E6AB02"
polygon_alpha <- 0.25
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/lambda_tempdorm_CI.pdf",useDingbats = F,height=5,width=5)
...
plot(all_tempdorm_seq,lambda_tempdorm_all_2sex,type="l",lwd=2,col=cbPalette[1],
     xlab="Temperature of dormant season",ylab=expression(paste(lambda)),cex.lab=1,ylim=c(0.75,5))
abline(h=1,col="blue")
...
lambdamiroc85<-read.csv("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/lambda_miroc8510m.csv")
```
...
```{r}
lambda_past$lambdabinary<-ifelse(lambda_past$lambda<1,0,1)
(lambda_map_past_binary <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = lambda_past, aes(x = x, y = y, fill = lambdabinary))+
  annotate(geom="text", x=-100, y=41, label="Past",
              color="grey")+
  scale_fill_gradientn(
    name = expression(paste(lambda)),
...
```{r}
lambda_current$lambdabinary<-ifelse(lambda_current$lambda<1,0,1)
(lambda_map_current_binary <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = lambda_current, aes(x = x, y = y, fill = lambdabinary))+
  annotate(geom="text", x=-100, y=41, label="Current",
              color="grey")+
  scale_fill_gradientn(
    name = expression(paste(lambda)),
...
```{r}
lambdamicroc45$lambdabinary<-ifelse(lambdamicroc45$lambda<1,0,1)
(lambda_map_miroc45_binary <- ggplot()+
  # geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
  # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = lambdamicroc45, aes(x = x, y = y, fill = lambdabinary))+
  annotate(geom="text", x=-100, y=41, label="Miroc45",
              color="grey")+
  scale_fill_gradientn(
    name = expression(paste(lambda)),
...
```{r}
lambdamiroc85$lambdabinary<-ifelse(lambdamiroc85$lambda<1,0,1)
(lambda_map_miroc85_binary <- ggplot()+
 #  geom_map(data = outline_map, map = outline_map, aes(map_id = region), color = "grey", linewidth = .1, fill = "#FAF9F6")+
 # coord_sf(xlim = c(-110,-90), ylim = c(25,45)) +
  geom_tile(data = lambdamiroc85, aes(x = x, y = y, fill = lambdabinary))+
  annotate(geom="text", x=-100, y=41, label="Miroc85",
              color="grey")+
  scale_fill_gradientn(
    name = expression(paste(lambda)),
...
```{r}
ggarrange(lambda_map_past_binary, lambda_map_current_binary, lambda_map_miroc45_binary, lambda_map_miroc85_binary,common.legend = TRUE)
```

```{r}
clim_acc_85_values<-terra::extract(clim_access_45,coordinates_study_area)
