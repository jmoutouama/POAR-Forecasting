...
par(mar=c(5,5,1,1),mfrow=c(2,1))
fields::image.plot(all_pptdorm_seq,all_tempdorm_seq,OSR_mtrx_dorm,col=topo.colors(100),xlab="Precipitation dormant",ylab="Temperature dormant",main="",breaks = scal_breaks) 
