...
## Two sex models -----
### The estimation of the Probability of lambda being higher than 1 across geographic space for the two sex model was estimated using the German Centre for Integrative Biodiversity Research (iDiv) supercomputer. Even with that supercomputer, running the code  will take a while (week). Please take a look at (future_clust_lambda.R) and code Bash (submit_array_future_lambda). 
...
data_current_fd<-data.frame(lambda_post_current)
#write.csv(data_current_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/lambda_post_current.csv")
...
data_past_fd<-data.frame(lambda_post_past)
# write.csv(data_past_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_past_fd.csv")
# write_rds(data_past_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_past_fd.rds")
...
data_acc45_fd<-data.frame(lambda_acc45)
# write.csv(data_acc45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_acc45_fd.csv")
# write_rds(data_acc45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_acc45_fd.rds")
...
data_acc85_fd<-data.frame(lambda_acc85)
...
data_ces45_fd<-data.frame(lambda_ces45)
# dim(data_ces85_fd)
# write.csv(data_ces45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_ces45_fd.csv")
# write_rds(data_ces45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_ces45_fd.rds")
...
data_cmc45_fd<-data.frame(lambda_cmc45)
# write.csv(data_cmc45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_cmc45_fd.csv")
# write_rds(data_cmc45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_cmc45_fd.rds")
...
data_cmc85_fd<-data.frame(lambda_cmc85)
# write.csv(data_cmc85_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_cmc85_fd.csv")
# write_rds(data_cmc85_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_cmc85_fd.rds")
...
data_cmc45_fd<-data.frame(lambda_cmc45)
# write.csv(data_miroc45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_miroc45_fd.csv")
# write_rds(data_miroc45_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_miroc45_fd.rds")
...
data_miroc85_fd<-data.frame(lambda_miroc85)
# write.csv(data_miroc85_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_miroc85_fd.csv")
# write_rds(data_miroc85_fd,"C:/Users/jm200/Documents/Projection/2024/Geoprojectfd/data_miroc85_fd.rds")
