...
model {
  ...
  bsize_s ~ normal(0, 1);   
  bsex_s ~ normal(0, 1);   
  bpptgrow_s ~ normal(0, 1);  
  bpptdorm_s ~ normal(0, 1);  
  btempgrow_s ~ normal(0, 1); 
  bsizesex_s ~ normal(0, 1); 
  btempdormpptdorm_s ~ normal(0, 1); 
  btempgrowpptgrow_s ~ normal(0, 1); 
  btempdorm_s ~ normal(0, 1);
  bpptgrowsex_s ~ normal(0, 1);
  bpptdormsex_s ~ normal(0, 1);
  btempgrowsex_s ~ normal(0, 1);
  btempdormsex_s ~ normal(0, 1);
  btempdormpptdormsex_s ~ normal(0, 1);
  btempgrowpptgrowsex_s ~ normal(0, 1);
  ...
  bsize_g ~ normal(0, 1);   
  bsex_g ~ normal(0, 1);   
  bpptgrow_g ~ normal(0, 1);  
  bpptdorm_g ~ normal(0, 1);  
  btempgrow_g ~ normal(0, 1);  
  btempdorm_g ~ normal(0, 1);
  bsizesex_g ~ normal(0, 0.25);
  btempdormpptdorm_g ~ normal(0, 1);
  btempgrowpptgrow_g ~ normal(0, 1);
  bpptgrowsex_g ~ normal(0, 1);
  bpptdormsex_g ~ normal(0, 1);
  btempgrowsex_g ~ normal(0, 1);
  btempdormsex_g ~ normal(0, 1);
  btempdormpptdormsex_g ~ normal(0,1);
  btempgrowpptgrowsex_g ~ normal(0, 1);
  bpptgrow2sex_g ~ normal(0, 1);  
  bpptdorm2sex_g ~ normal(0, 1); 
  btempgrow2sex_g ~ normal(0, 1);  
  btempdorm2sex_g ~ normal(0, 1); 
  bpptgrow2_g ~ normal(0, 1); 
  bpptdorm2_g ~ normal(0, 1); 
  btempgrow2_g ~ normal(0,1); 
  btempdorm2_g ~ normal(0, 1); 
  ...
  b0_f ~ normal(0, 1);    
  bsize_f ~ normal(0, 1);  
  bsizesex_f ~ normal(0, 1);  
  bsex_f ~ normal(0, 1);   
  bpptgrow_f ~ normal(0, 1);  
  bpptdorm_f ~ normal(0, 1);  
  btempgrow_f ~ normal(0, 1);  
  btempdorm_f ~ normal(0, 1);
  bpptgrowsex_f ~ normal(0, 1);
  bpptdormsex_f ~ normal(0, 1);
  btempgrowsex_f ~ normal(0, 1);
  btempdormsex_f ~ normal(0, 1);
  btempdormpptdorm_f ~ normal(0,1);
  btempgrowpptgrow_f ~ normal(0, 1);
  ...
  bsize_p ~ normal(0, 1);   
  bsex_p ~ normal(0, 1);   
  bpptgrow_p ~ normal(0, 1);  
  bpptdorm_p ~ normal(0, 1);  
  btempgrow_p ~ normal(0, 1);  
  btempdorm_p ~ normal(0, 1);
  bsizesex_p ~ normal(0, 1);
  btempdormpptdorm_p ~ normal(0,1);
  btempgrowpptgrow_p ~ normal(0, 1);
  bpptgrowsex_p ~ normal(0, 1);
  bpptdormsex_p ~ normal(0, 1);
  btempgrowsex_p ~ normal(0, 1);
  btempdormsex_p ~ normal(0, 1);
  btempdormpptdormsex_p ~ normal(0,1);
  btempgrowpptgrowsex_p ~ normal(0, 1);
