...
model {
  ...
  bpptgrow2sex_p ~ normal(0,5 );  
  bpptdorm2sex_p ~ normal(0, 5); 
  btempgrow2sex_p ~ normal(0, 5);  
  btempdorm2sex_p ~ normal(0, 5); 
  bpptgrow2_p ~ normal(0, 5); 
  bpptdorm2_p ~ normal(0, 5); 
  btempgrow2_p ~ normal(0, 5); 
  btempdorm2_p ~ normal(0, 5); 
