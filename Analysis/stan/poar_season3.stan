...
model {
  ...
  bpptgrow2sex_s ~ normal(0, 100);  
  bpptdorm2sex_s ~ normal(0, 100); 
  btempgrow2sex_s ~ normal(0, 100);  
  btempdorm2sex_s ~ normal(0, 100); 
  bpptgrow2_s ~ normal(0, 100); 
  bpptdorm2_s ~ normal(0, 100); 
  btempgrow2_s ~ normal(0, 100); 
  btempdorm2_s ~ normal(0, 100); 
  ...
  bpptgrow2sex_g ~ normal(0, 100);  
  bpptdorm2sex_g ~ normal(0, 100); 
  btempgrow2sex_g ~ normal(0, 100);  
  btempdorm2sex_g ~ normal(0, 100); 
  bpptgrow2_g ~ normal(0, 100); 
  bpptdorm2_g ~ normal(0, 100); 
  btempgrow2_g ~ normal(0, 100); 
  btempdorm2_g ~ normal(0, 100); 
  ...
  btempdormpptdormsex_f ~ normal(0, 100);
  btempgrowpptgrowsex_f ~ normal(0, 100);
  bpptgrow2_f ~ normal(0, 100); 
  bpptdorm2_f ~ normal(0, 100);
  btempgrow2_f ~ normal(0, 100);
  btempdorm2_f ~ normal(0, 100);
  bpptgrow2sex_f ~ normal(0, 100);
  bpptdorm2sex_f ~ normal(0, 100); 
  btempgrow2sex_f ~ normal(0, 100); 
  btempdorm2sex_f ~ normal(0, 100); 
  ...
  bpptgrow2sex_p ~ normal(0, 100);  
  bpptdorm2sex_p ~ normal(0, 100); 
  btempgrow2sex_p ~ normal(0, 100);  
  btempdorm2sex_p ~ normal(0, 100); 
  bpptgrow2_p ~ normal(0, 100); 
  bpptdorm2_p ~ normal(0, 100); 
  btempgrow2_p ~ normal(0, 100); 
  btempdorm2_p ~ normal(0, 100); 
