  ...
  for(i in 1:size_bin_num){
    ...
    fem_f <- invlogit((flow_coef$b0_f[post_draws[p]]) + 
     ...
     fem_p <- exp((panic_coef$b0_p[post_draws[p]]) + 
                         ...
                         (panic_coef$bpptdorm_p[post_draws[p]]) * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s]  +
                         (panic_coef$btempgrow_p[post_draws[p]]) * flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s] +
                         (panic_coef$btempdorm_p[post_draws[p]]) * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] +
                         (panic_coef$bpptgrowsex_p[post_draws[p]]) * pptgrow_seq * (s-1) +
                         (panic_coef$bpptdormsex_p[post_draws[p]]) * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s]  * (s-1) +
                         (panic_coef$btempgrowsex_p[post_draws[p]]) * flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s] * (s-1) +
                        (panic_coef$btempdormsex_p[post_draws[p]]) * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] * (s-1) +
                         (panic_coef$btempdormpptdorm_p[post_draws[p]]) * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s] * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] +
                         (panic_coef$btempgrowpptgrow_p[post_draws[p]]) * pptgrow_seq * flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s] +
                         (panic_coef$btempdormpptdormsex_p[post_draws[p]]) * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s] * (s-1) +
                         ...
                         (panic_coef$bpptdorm2_p[post_draws[p]]) * (flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s])^2 +
                         (panic_coef$btempgrow2_p[post_draws[p]]) * (flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s])^2 +
                         (panic_coef$btempdorm2_p[post_draws[p]]) * (flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s])^2 +
                         (panic_coef$bpptgrow2sex_p[post_draws[p]]) * (pptgrow_seq^2) * (s-1) +
                         (panic_coef$bpptdorm2sex_p[post_draws[p]]) * (flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s])^2 * (s-1) +
                         (panic_coef$btempgrow2sex_p[post_draws[p]]) * (flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s])^2 * (s-1) +
                         (panic_coef$btempdorm2sex_p[post_draws[p]]) * (flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s])^2 * (s-1)
...
#print figure
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/vital_rates_3B.pdf",height = 14,width = 10,useDingbats = F)
  ...
  for(i in 1:size_bin_num){
    ...
    for(s in 1:2){
      ...
      lines(pptgrow_seq, exp(mean(panic_coef$b0_p) + 
                         ...
                         mean(panic_coef$bpptdorm_p) * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s]  +
                         mean(panic_coef$btempgrow_p) * flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s] +
                         mean(panic_coef$btempdorm_p) * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] +
                         mean(panic_coef$bpptgrowsex_p) * pptgrow_seq * (s-1) +
                         mean(panic_coef$bpptdormsex_p) * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s]  * (s-1) +
                         mean(panic_coef$btempgrowsex_p) * flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s] * (s-1) +
                        mean(panic_coef$btempdormsex_p) * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] * (s-1) +
                         mean(panic_coef$btempdormpptdorm_p) * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s] * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] +
                         mean(panic_coef$btempgrowpptgrow_p) * pptgrow_seq * flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s] +
                         mean(panic_coef$btempdormpptdormsex_p) * flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s] * flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s] * (s-1) +
                         ...
                         mean(panic_coef$bpptdorm2_p) * (flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s])^2 +
                         mean(panic_coef$btempgrow2_p) * (flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s])^2 +
                         mean(panic_coef$btempdorm2_p) * (flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s])^2 +
                         mean(panic_coef$bpptgrow2sex_p) * (pptgrow_seq^2) * (s-1) +
                         mean(panic_coef$bpptdorm2sex_p) * (flow_mean_pptdorm$pptdorm[flow_mean_pptdorm$Sex==s])^2 * (s-1) +
                         mean(panic_coef$btempgrow2sex_p) * (flow_mean_tempgrow$tempgrow[flow_mean_tempgrow$Sex==s])^2 * (s-1) +
                         mean(panic_coef$btempdorm2sex_p) * (flow_mean_tempdorm$tempdorm[flow_mean_tempdorm$Sex==s])^2 * (s-1)
...
layout.matrix <- rbind(matrix(1:6, nrow = 2, ncol = 3, byrow = F),
                       ...
                       matrix(19:24, nrow = 2, ncol = 3, byrow = F))
#print figure
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/vital_rates_3TB.pdf",height = 14,width = 10,useDingbats = F)
layout(mat = layout.matrix,
       heights = rep(c(2, 1),4), # Heights of the two rows
       widths = c(2, 2, 2))
#layout.show(24)
