...
#SURVIVAL AT SIZE X.
sx<-function(x,params,pptgrow,tempgrow,pptdorm,tempdorm,rfx,surv_perturb=0){
...
#This function truncates the density association with x==0 and x>x.max
gxy<-function(x,y,params,pptgrow,tempgrow,pptdorm,tempdorm,rfx,grow_perturb=0){
...
#SURVIVAL*GROWTH 
pxy<-function(x,y,params,pptgrow,tempgrow,pptdorm,tempdorm,rfx,surv_perturb=0,grow_perturb=0){
  sx(x,params,pptgrow,tempgrow,rfx,surv_perturb) * gxy(x,y,params,pptgrow,tempgrow,rfx,grow_perturb)
}



# PROBABILITY OF FLOWERING
pfx<-function(x,params, pptgrow,tempgrow,pptdorm,tempdorm,rfx,flow_perturb=0){
...
#NUMBER OF PANICLES
nfx<-function(x,params,pptgrow,tempgrow,pptdorm,tempdorm,rfx,fert_perturb=0){
...
##Female offspring
fertx_F<-function(x,params,rfx,pptgrow,tempgrow,pptdorm,tempdorm,twosex,OSR=NULL,flow_perturb=0,fert_perturb=0,viab_perturb=0){
  seedlings<-pfx(x,params,pptgrow,tempgrow,pptdorm,tempdorm,rfx,flow_perturb)*nfx(x,params,pptgrow,tempgrow,pptdorm,tempdorm,rfx,fert_perturb)*params$ov_per_inf*viab(params,twosex,OSR,viab_perturb)*params$germ*params$PSR
  return(seedlings)
}


##Male offspring
fertx_M<-function(x,params,rfx,pptgrow,tempgrow,pptdorm,tempdorm,twosex,OSR=NULL,flow_perturb=0,fert_perturb=0,viab_perturb=0){
  seedlings<-pfx(x,params,pptgrow,tempgrow,rfx,flow_perturb)*nfx(x,params,pptgrow,tempgrow,pptdorm,tempdorm,rfx,fert_perturb)*params$ov_per_inf*viab(params,twosex,OSR,viab_perturb)*params$germ*(1-params$PSR)
  return(seedlings)
}


megamatrix_delay<-function(F_params,M_params,pptgrow,tempgrow,pptdorm,tempdorm,twosex,OSR=NULL,rfx,
  ...
  test<-t(outer(y,y,pxy,params=F_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,surv_perturb=surv_perturb, grow_perturb=grow_perturb))
  test<-t(outer(y,y,gxy,params=F_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,grow_perturb=grow_perturb))
  # surviving seedlings emerge in continuous population
  F.Tmat[2:(matdim+1),1] <- gxy(x=1,y=y,params=F_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,grow_perturb=grow_perturb) * (M_params$sdlg_surv + surv_perturb)
  
  # F-to-F Fertility transition
  F.Fmat<-matrix(0,matdim+1,matdim+1)
  # seedlings in top row
  F.Fmat[1,2:(matdim+1)]<-fertx_F(x=y,params=F_params,rfx=rfx,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,twosex=twosex,OSR=OSR,flow_perturb=flow_perturb,fert_perturb=fert_perturb,viab_perturb=viab_perturb) 
  
  ## M-to-M (growth/survival transition)
  M.Tmat<-matrix(0,matdim+1,matdim+1)
  M.Tmat[2:(matdim+1),2:(matdim+1)]<-t(outer(y,y,pxy,params=M_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,surv_perturb=surv_perturb, grow_perturb=grow_perturb))
  M.Tmat[2:(matdim+1),1] <- gxy(x=1,y=y,params=M_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,grow_perturb=grow_perturb) * (M_params$sdlg_surv + surv_perturb)
  
  # F-to-M Fertility transition
  M.Fmat<-matrix(0,matdim+1,matdim+1)
  M.Fmat[1,2:(matdim+1)]<-fertx_M(x=y,params=F_params,rfx=rfx,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,twosex=twosex,OSR=OSR,flow_perturb=flow_perturb,fert_perturb=fert_perturb,viab_perturb=viab_perturb) 
...
lambdaSim_delay<-function(F_params,M_params,pptgrow,tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx,max.yrs,
  ...
  for(t in 1:max.yrs){
    ##Estimate panicle SR
    flowering_females<-n0[2:(matdim+1)]*pfx(x=y,param=F_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,flow_perturb=flow_perturb) ## scalar multiplication to weight females by flowering prob
    F_panicles<-flowering_females%*%nfx(x=y,param=F_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,fert_perturb=fert_perturb) ##Vector operation to sum female panicles
    flowering_males<-n0[(matdim+3):((matdim+1)*2)]*pfx(x=y,param=M_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,flow_perturb=flow_perturb)
    M_panicles<-flowering_males%*%nfx(x=y,param=M_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,rfx=rfx,fert_perturb=fert_perturb)
    OSRtracker[t]<-F_panicles/(F_panicles+M_panicles) ##Panicle sex ratio (proportion female)
    SRtracker[t]<-sum(n0[1:(matdim+1)])
    #assmble matrix
    MEGAmat<-megamatrix_delay(F_params=F_params,M_params=M_params,pptgrow=pptgrow,tempgrow=tempgrow,pptdorm=pptdorm,tempdorm=tempdorm,twosex=T,OSR=OSRtracker[t],rfx=rfx,
