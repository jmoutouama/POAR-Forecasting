...
sx<-function(x,params,pptgrow,pptdorm,tempgrow,tempdorm,rfx,surv_perturb=0){
  ...
  pptgrow_scaled_s=(pptgrow-547.8401)/215.4426
  pptdorm_scaled_s=(pptdorm-351.0187)/82.0286
  tempgrow_scaled_s=(tempgrow- 15.19682)/2.952712
  tempdorm_scaled_s=(tempdorm-28.26755)/1.129604
...
gxy<-function(x,y,params,pptgrow,pptdorm,tempgrow,tempdorm,rfx,grow_perturb=0){
    ...
    pptgrow_scaled_g=(pptgrow-528.9914)/221.8747
    pptdorm_scaled_g=(pptdorm- 341.9198)/ 79.59822 
    tempgrow_scaled_g=(tempgrow-15.31704)/ 2.932009
    tempdorm_scaled_g=(tempdorm- 28.24693)/ 1.132769
...
pfx<-function(x,params, pptgrow,pptdorm,tempgrow,tempdorm,rfx,flow_perturb=0){
  ...
  pptgrow_scaled_f=(pptgrow-529.5757 )/223.0247
  pptdorm_scaled_f=(pptdorm-341.1608)/78.73288
  tempgrow_scaled_f=(tempgrow-15.34869)/2.918175
  tempdorm_scaled_f=(tempdorm-28.25719)/1.126273
...
nfx<-function(x,params,pptgrow,pptdorm,tempgrow,tempdorm,rfx,fert_perturb=0){
  ...
  pptgrow_scaled_p=(pptgrow- 417.0955)/168.1431 
  pptdorm_scaled_p=(pptdorm-305.1769)/58.54791
  tempgrow_scaled_p=(tempgrow-14.67626)/2.814815
  tempdorm_scaled_p=(tempdorm- 28.03949)/1.10716
...
megamatrix_delay_acc45<-function(F_params,M_params,pptgrow,pptdorm,tempgrow,tempdorm,twosex,OSR=NULL,rfx,
...
lambdaSim_delay_acc45<-function(F_params,M_params,pptgrow,pptdorm,tempgrow,tempdorm,rfx,max.yrs,
