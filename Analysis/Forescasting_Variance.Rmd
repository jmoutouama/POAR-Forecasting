...
saveRDS(fit_allsites_season, '/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/Forecasting Models output/fit_allsites_seasons_1_03_24.rds')
```

## Chains convergence

```{r}
fit_allsites_season <- readRDS(url("https://www.dropbox.com/scl/fi/0oettkb5rlpix76jko7rv/fit_variance_1.5_0.5.rds?rlkey=lj9gf1fxeh1yp8549zhsv1sv0&dl=1"))
...
# print figure
# pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/PPCVariance.pdf",useDingbats = F,height=10,width=6)
...
```{r,eval=FALSE}
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/Posterior_mean_vital_variance.pdf",useDingbats = F,height=8,width=9)
...
grow_coef <- rstan::extract(fit_full, pars = quote_bare(b0_g,btempdormpptdorm_g,btempgrowpptgrow_g,bsizesex_g,bsex_g,
                                                        ...
                                                        site_tau,block_tau,source_tau,sigma))
...
#print figure
pdf("/Users/jm200/Library/CloudStorage/Dropbox/Miller Lab/github/POAR-Forecasting/Manuscript/Figures/vital_rates_poolingvariance.pdf",height = 14,width = 13,useDingbats = F)
...
mean_coefs<- lapply(rstan::extract(fit_full, pars = quote_bare(b0_s,bsizesex_s,btempdormpptdorm_s,btempgrowpptgrow_s,bsex_s,
                                                        ...
                                                        bpptdorm2_s,btempgrow2_s,btempdorm2_s,bpptgrow2sex_s,bpptdorm2sex_s,
                                                        btempgrow2sex_s,btempdorm2sex_s,
                                                        site_tau,block_tau,source_tau)) ,mean)
...
mean_coefg<- lapply(rstan::extract(fit_full, pars = quote_bare(b0_g,btempdormpptdorm_g,btempgrowpptgrow_g,bsizesex_g,bsex_g,
                                                        ...
                                                        site_tau,block_tau,source_tau,sigma)) ,mean)
...
```{r}
all_pptgrow<-c(zclim_current$zpptgrow,zclim_past$zpptgrow,zclim_miroc45$zpptgrow,zclim_miroc85$zpptgrow)
...
plot(all_pptgrow_seq,lambda_pptgrow_all_2sex,type="l",lwd=2,col=cbPalette[1],
     xlab="Precipitation  of the growing season",ylab=expression(paste(lambda)),cex.lab=1)
abline(h=1,col="blue")
...
```{r}
all_tempgrow<-c(zclim_current$ztempgrow,zclim_past$zempgrow,zclim_miroc45$ztempgrow,zclim_miroc85$ztempgrow)
...
plot(all_tempgrow_seq,lambda_tempgrow_all_2sex,type="l",lwd=2,col=cbPalette[1],
     xlab="Temperature of growing season",ylab=expression(paste(lambda)),cex.lab=1)
abline(h=1,col="blue")
...
plot(all_pptdorm_seq,lambda_pptdorm_all_2sex,type="l",lwd=2,col=cbPalette[1],
     xlab="Precipitation of dormant season",ylab=expression(paste(lambda)),cex.lab=1)
abline(h=1,col="blue")
...
```{r}
all_tempdorm<-c(zclim_current$ztempdorm,zclim_past$ztempdorm,zclim_miroc45$ztempdorm,zclim_miroc85$ztempdorm)
...
plot(all_tempdorm_seq,lambda_tempdorm_all_2sex,type="l",lwd=2,col=cbPalette[1],
     xlab="Temperature of dormant season",ylab=expression(paste(lambda)),cex.lab=1)
abline(h=1,col="blue")
