...
transformed parameters {
  ...
  for(ipan in 1:n_p){
    predP[ipan] = b0_p + 
                ...
                bppt2_p * pow(ppt_p [ipan],2) + 
                btemp2_p * pow(temp_p [ipan],2) + 
                bcvppt2_p * pow(cvppt_p [ipan],2) + 
                bppt2sex_p * male_p [ipan] * pow(ppt_p[ipan],2) +
                btemp2sex_p * male_p [ipan] * pow(temp_p[ipan],2) +
                bcvppt2sex_p * male_p [ipan] * pow(cvppt_p[ipan],2) +
